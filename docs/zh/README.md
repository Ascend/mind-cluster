...
|故障诊断（faultdiag）|简介|01_introduction|整体介绍故障诊断工具是什么、应用场景及方案。|[简介](./faultdiag/ascend-faultdiag/01_introduction/menu_introduction.md)|
|-|前置知识|02_prerequisites|介绍使用故障诊断所需前置知识。|[前置知识](./faultdiag/ascend-faultdiag/02_prerequisites/prerequisites.md)|
|-|快速入门|03_quick_start|介绍故障诊断工具的快速入门指导。|[快速入门](./faultdiag/ascend-faultdiag/03_quick_start/quick_start.md)|
|-|安装指南|04_installation_guide|介绍故障诊断工具的安装及维护。|[安装指南](./faultdiag/ascend-faultdiag/04_installation_guide/menu_installation_guide.md)|
|-|特性指南|05_usage|介绍故障诊断工具的使用方法。|[特性指南](./faultdiag/ascend-faultdiag/05_usage/menu_usage.md)|
|-|API参考|06_api|介绍故障诊断工具的API接口。|[API参考](./faultdiag/ascend-faultdiag/06_api/menu_api.md)|
|-|参考|07_references|介绍故障诊断工具的常用操作、FAQ、安全加固等内容。|[参考](./faultdiag/ascend-faultdiag/07_references/menu_references.md)|
