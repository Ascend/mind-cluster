...
[pod_manager]
# PoDManager 为 Atlas 950 SuperPoD超节点的设备统一管理入口，登录后会切换到各个槽位号采集信息
...
- 其中 PoDManager 是 Atlas 950 SuperPoD超节点的设备统一管理入口，请填写到 `pod_manager` 选项框中。配置后工具会登录 PoDManager，按内置槽位表逐槽位切换采集各槽位对应的信息。
