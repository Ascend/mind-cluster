...
本文档是用户使用集群调度组件的指导文档，在安装和使用集群调度组件前，用户需要提前了解[集群调度组件的特性](./02_feature_description.md)，并根据具体特性的特点和功能，选择需要使用的特性并[安装相应的组件](../03_installation_guide/02_installation/00_helm_installation.md)。

## 使用流程<a name="section10118105218514"></a>

集群调度组件的安装和使用流程如下图所示。

![集群调度组件安装和使用流程图](../../figures/scheduling/zh-cn_image_0000002511426865.png)
