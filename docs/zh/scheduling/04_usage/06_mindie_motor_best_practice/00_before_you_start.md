...
在部署MindIE Motor前，需要确保相关组件已经安装，若没有安装，可以参考[安装部署](../../05_developer_guide/00_installation_deployment/00_manual_installation/00_obtaining_software_packages.md)章节进行操作。

- Volcano
- Ascend Device Plugin
- Ascend Docker Runtime
- Ascend Operator，且需将启动参数[enableGangScheduling](../../05_developer_guide/00_installation_deployment/00_manual_installation/08_ascend_operator.md#参数说明)的取值设置为true
- ClusterD
- NodeD
