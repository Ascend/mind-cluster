...
已完成Ascend Device Plugin组件安装，详细请参见[安装Ascend Device Plugin](../../05_developer_guide/00_installation_deployment/00_manual_installation/04_ascend_device_plugin.md)。
...
1. 查看Ascend Device Plugin Daemonset的信息。
...
2. 编辑Ascend Device Plugin组件的daemonset。
