...
> [!NOTE]
> 以下示例中以 `#` 开头的注释仅用于说明字段含义，应用ConfigMap前请删除所有以 `#` 开头的注释行，否则应用解析elastic_scaling.json字符串时会因JSON解析失败。
...
## 查看弹性扩缩容结果<a name="zh-cn_topic_0000002356673977_zh-cn_topic_0000002098814658_section463203519255"></a>
