...
|UB网卡故障|UB（Unified Bus）网卡故障是指Atlas 950 SuperPoD 超节点、Atlas 850E 超节点和Atlas 650E 服务器中使用的UB网卡的故障，包括UB端口故障、UB通道降lane、HCA端口故障、Bond成员故障和DPU掉卡故障。由K8s RDMA Shared Dev Plugin组件负责检测。|
