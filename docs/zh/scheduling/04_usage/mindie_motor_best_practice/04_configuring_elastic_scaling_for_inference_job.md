...
4. ClusterD将global-ranktable发送给MindIE Controller，关于global-ranktable的说明请参见[SubscribeRankTable](../../05_api/clusterd/05_service_configuration_apis.md#subscriberanktable)中“global-ranktable文件说明”表。
...
## 查看弹性扩缩容结果<a name="zh-cn_topic_0000002356673977_zh-cn_topic_0000002098814658_section463203519254"></a>
...
当推理任务运行中d0实例所在节点发生硬件或软件故障且当前资源不满足所有实例拉起时，降低运行的实例数量。
...
任务此时根据设置的扩缩容规则，按照另一个可以正常运行的任务配比状态运行，d0的Pod会退出并被重新拉起，p0或p1进入pending状态等待资源。
