...
2. 执行以下命令，创建npu\_plugin.conf文件。
   ...
   |-deviceResetTimeout|int|600| 组件启动时，若芯片数量不足，等待驱动上报完整芯片的最大时长，单位为秒，取值范围为10～600。<ul><li><term>Atlas A2 训练系列产品</term>、Atlas 800I A2 推理服务器、A200I A2 Box 异构组件：建议配置为150秒。</li><li><term>Atlas A3 训练系列产品</term>、Atlas 800I A3 超节点服务器：建议配置为360秒。</li><li><term>Ascend 950PR&950DT系列产品</term>：建议配置为600秒。</li></ul> |否|
