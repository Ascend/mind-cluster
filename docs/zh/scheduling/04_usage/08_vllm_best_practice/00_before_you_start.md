...
在部署vLLM推理任务前，需要确保相关组件已经安装，若没有安装，可以参考[安装部署](../../05_developer_guide/00_installation_deployment/00_manual_installation/00_obtaining_software_packages.md)章节进行操作。
...
- [通过命令行使用](./01_deploying_vllm_inference_job.md#通过命令行使用)：通过配置的YAML文件部署任务。
- [通过脚本一键式部署使用](./01_deploying_vllm_inference_job.md#通过脚本一键式部署使用)：通过自动化脚本参考设计部署任务。
