...
在无K8s的场景下，训练或推理进程异常后，没有有效的恢复手段。为了解决上述问题，可以配置容器恢复特性。若要支持容器恢复特性，需要安装Container Manager组件。Container Manager组件的安装操作详细请参见[安装部署](../../05_developer_guide/00_installation_deployment/00_manual_installation/00_obtaining_software_packages.md)。
...
|功能名称|说明|原理介绍及配置步骤|
|--|--|--|
|故障检测|该特性具有故障检测功能，支持实时检测350+硬件类故障。|[故障检测](#故障检测)|
...
>[!NOTE]
>
>- 每个故障对应的故障信息请参见[芯片故障码参考文档](../../07_references/05_appendix.md#芯片故障码参考文档)。
...
3. 各节点收到停止请求后，为其余容器打上停止标识，并在本节点的故障处理周期中停止这些容器。
