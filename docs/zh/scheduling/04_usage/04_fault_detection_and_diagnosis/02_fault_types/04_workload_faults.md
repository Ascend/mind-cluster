...
>- 任务状态可以接入外部监控平台，Job状态可以通过[ClusterD的任务接口](../../../06_api/04_clusterd/01_job_information.md)监控到任务状态变更。业务面Pod非0退出，状态变成Failed时，或者任务长时间处于Pending状态时，都能够通过任务信息接口获取到相关信息。
