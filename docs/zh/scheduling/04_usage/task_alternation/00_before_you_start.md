...
- 已完成Volcano、Ascend Device Plugin、Ascend Docker Runtime、Ascend Operator、ClusterD、NodeD的安装部署，详细请参见[安装部署](../../05_developer_guide/installation_deployment/manual_installation/00_obtaining_software_packages.md)。
