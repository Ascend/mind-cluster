...
如果是acjob任务，在配置YAML前，请先了解相关YAML参数说明，详细说明如[acjob任务yaml参数说明](../../05_api/yaml_configuration.md#acjob)所示。
...
用户已创建[hccl.json](../../05_api/hccl.json_file_description.md)文件的具体挂载路径，详细操作步骤请参见[Ascend Operator](../../07_developer_guide/installation_deployment/manual_installation/08_ascend_operator.md)中的“步骤4”。
