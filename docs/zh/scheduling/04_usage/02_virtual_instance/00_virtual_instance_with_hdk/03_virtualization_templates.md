...
<table>
    ...
    <tr>
        <td><term>Atlas A3 训练系列产品</term>（48个AICore）</td>
        <td>虚拟化实例模板包括：vir06_1c_16g、vir12_3c_32g。</td>
        <td><ul><li>vir后面的数字表示AICore数量。</li><li>c前面的数字表示AICPU数量。</li><li>g前面的数字表示内存数量。</li></ul></td>
    </tr>
    <tr>
        <td><term>Atlas A3 推理系列产品</term>（40个AICore）</td>
...
>[!NOTE]
>昇腾AI处理器包含AICore、AICPU、DVPP、内存等硬件资源，主要用途如下：
>
