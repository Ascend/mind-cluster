...
<p>分配的芯片信息会在PodGroup的如下label中体现出来，关于PodGroup label的详细说明请参见<a href="../../../06_api/01_volcano.md#podgroup">PodGroup label</a>中的如下参数：
<ul>
...
<tr><td class="cellrowborder" valign="top" headers="mcps1.2.3.1.1 "><p>支持芯片故障和节点故障的重调度。具体参考<a href="../../03_basic_scheduling/06_recovery_of_inference_card_faults.md">硬件故障恢复</a>和<a href="../../03_basic_scheduling/05_rescheduling_upon_inference_card_faults.md">硬件故障重调度</a>章节。</p>
</td>
</tr>
