...
从Atlas A3 系列产品升级至Ascend 950 系列产品场景下，任务YAML可能的修改点请参见[表1](#zh-cn_topic_0000001609074213_table5589101114528)，若其中可选配置项未使用，可忽略。[表2](#zh-cn_topic_0000001609074213_table5589101114529)以Atlas 950 SuperPoD为例，提供了YAML文件的具体配置样例。
...
**表 2**  Ascend 950 系列产品任务YAML文件样例参考
