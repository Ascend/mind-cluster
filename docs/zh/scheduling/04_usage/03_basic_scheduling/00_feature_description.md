...
- 推理任务：[整卡调度](../../01_introduction/02_feature_description.md#整卡调度)、[硬件故障恢复](../../01_introduction/02_feature_description.md#硬件故障恢复)和[硬件故障重调度](../../01_introduction/02_feature_description.md#硬件故障重调度)。
