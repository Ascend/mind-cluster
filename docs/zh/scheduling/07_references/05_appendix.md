...
>[!NOTE]
>如果边缘管理平台不支持该目录下日志文件的轮转或日志轮转配置错误，会导致<b>/var/lib/docker</b>被占满，从而影响新容器的部署及其他容器业务的正常运行。故不建议采用该方式。
...
应用将容器日志挂载到边缘主机上。边缘管理平台提供主机上日志收集能力，并将主机文件日志进行轮转。

>[!NOTE]
>
>- 应用可以将容器日志挂载到主机上的非关键大容量目录，建议不要挂载到eMMC等存储介质上，避免影响硬件整体寿命。
>- 边缘容器管理平台一般会支持该能力，以减少对系统目录<b>/var/lib/docker</b>的影响。基于安全性考虑，该配置需要符合所在组织的安全要求。
...
<td class="cellrowborder" rowspan="2" valign="top" width="57.14%" headers="mcps1.2.3.1.2 "><p id="p1354341203715"><a name="p1354341203715"></a><a name="p1354341203715"></a>文件，驱动所需的动态库。</p>
...
<td class="cellrowborder" rowspan="2" valign="top" width="57.14%" headers="mcps1.2.3.1.2 "><p id="p19161449374"><a name="p19161449374"></a><a name="p19161449374"></a>文件，驱动所需的动态库。</p>
...
<td class="cellrowborder" rowspan="9" valign="top" width="57.14%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001538584750_p1189591513"><a name="zh-cn_topic_0000001538584750_p1189591513"></a><a name="zh-cn_topic_0000001538584750_p1189591513"></a>文件，驱动所需的动态库。</p>
</td>
</tr>
...
<td class="cellrowborder" rowspan="2" valign="top" width="57.14%" headers="mcps1.2.3.1.2 "><p id="p41371512123710"><a name="p41371512123710"></a><a name="p41371512123710"></a>文件，驱动所需的动态库。</p>
...
<td class="cellrowborder" rowspan="2" valign="top" width="57.14%" headers="mcps1.2.3.1.2 "><p id="p469285716395"><a name="p469285716395"></a><a name="p469285716395"></a>文件，驱动所需的动态库。</p>
...
<td class="cellrowborder" rowspan="12" valign="top" width="57.14%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001538584750_p28911240182511"><a name="zh-cn_topic_0000001538584750_p28911240182511"></a><a name="zh-cn_topic_0000001538584750_p28911240182511"></a>文件，驱动所需的动态库。</p>
</td>
</tr>
...
|/usr/lib64/libummu*|文件，UB驱动提供的用户态库，由于会有多个文件，因此支持通配符匹配。当宿主机不支持UB协议、不存在这些文件或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载。|
|/usr/lib64/liburma*|文件，UB驱动提供的用户态库，由于会有多个文件，因此支持通配符匹配。当宿主机不支持UB协议、不存在这些文件或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载。|
|/usr/lib64/urma|目录，UB驱动提供的用户态库目录，当宿主机不支持UB协议、不存在此目录或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载。|
|/usr/lib64/libnl*|文件，Netlink协议接口提供的用户态库，由于会有多个文件，因此支持通配符匹配。当宿主机不支持UB协议、不存在这些文件或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载。|
|/usr/bin/urma_admin|文件，当宿主机不支持UB协议、不存在该文件或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载该文件。|
|/usr/bin/urma_perftest|文件，当宿主机不支持UB协议、不存在该文件或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载该文件。|
|/usr/bin/urma_ping|文件，当宿主机不支持UB协议、不存在该文件或者指定参数ASCEND_UB_DRV_MOUNT=False时，不会挂载该文件。|
|/usr/local/Ascend/driver/lib64|目录，驱动提供的用户态库。|
...
Ascend Docker Runtime安装后，会在安装目录生成可执行工具，涉及到的指令为内部命令，用户请勿直接使用，相关指令如[表8](#zh-cn_topic_0000001538744718_table0615184315110)所示。
...
<tr id="zh-cn_topic_0000001538744718_row146209438117"><td class="cellrowborder" rowspan="5" valign="top" width="19.97%" headers="mcps1.2.6.1.1 "><p id="zh-cn_topic_0000001538744718_p19762345867"><a name="zh-cn_topic_0000001538744718_p19762345867"></a><a name="zh-cn_topic_0000001538744718_p19762345867"></a>ascend-docker-runtime</p>
...
<tr id="zh-cn_topic_0000001538744718_row26206433119"><td class="cellrowborder" valign="top" headers="mcps1.2.6.1.1 "><p id="zh-cn_topic_0000001538744718_p16620143414"><a name="zh-cn_topic_0000001538744718_p16620143414"></a><a name="zh-cn_topic_0000001538744718_p16620143414"></a>-</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0000001538744718_p154110591664"><a name="zh-cn_topic_0000001538744718_p154110591664"></a><a name="zh-cn_topic_0000001538744718_p154110591664"></a>start</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="zh-cn_topic_0000001538744718_p5620104318116"><a name="zh-cn_topic_0000001538744718_p5620104318116"></a><a name="zh-cn_topic_0000001538744718_p5620104318116"></a>-</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0000001538744718_p1862034312117"><a name="zh-cn_topic_0000001538744718_p1862034312117"></a><a name="zh-cn_topic_0000001538744718_p1862034312117"></a>-</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0000001538744718_p154110591664"><a name="zh-cn_topic_0000001538744718_p154110591664"></a><a name="zh-cn_topic_0000001538744718_p154110591664"></a>checkpoint</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="zh-cn_topic_0000001538744718_p5620104318116"><a name="zh-cn_topic_0000001538744718_p5620104318116"></a><a name="zh-cn_topic_0000001538744718_p5620104318116"></a>-</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0000001538744718_p1862034312117"><a name="zh-cn_topic_0000001538744718_p1862034312117"></a><a name="zh-cn_topic_0000001538744718_p1862034312117"></a>-</p>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="zh-cn_topic_0000001538744718_p154110591664"><a name="zh-cn_topic_0000001538744718_p154110591664"></a><a name="zh-cn_topic_0000001538744718_p154110591664"></a>resume</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="zh-cn_topic_0000001538744718_p5620104318116"><a name="zh-cn_topic_0000001538744718_p5620104318116"></a><a name="zh-cn_topic_0000001538744718_p5620104318116"></a>-</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0000001538744718_p1862034312117"><a name="zh-cn_topic_0000001538744718_p1862034312117"></a><a name="zh-cn_topic_0000001538744718_p1862034312117"></a>-</p>
...
## 镜像和二进制部署差异<a name="ZH-CN_TOPIC_0000002479386442"></a>
...
多管理节点场景需要保证所有管理节点配置一致，如集群调度组件镜像、日志目录、运行用户、节点标签等配置需一致。多管理节点下集群调度组件的安装请参见[安装部署](../03_installation_guide/02_installation/00_helm_installation.md)章节。多管理节点的安装请参见K8s官方文档[利用kubeadm创建高可用集群](https://kubernetes.io/zh-cn/docs/setup/production-environment/tools/kubeadm/high-availability/)。
...
Containerd安装流程请参见[官方资料](https://github.com/containerd/containerd/blob/master/BUILDING.md)。集群调度组件安装时默认使用Ascend Docker Runtime，可以配置Containerd使用Ascend Docker Runtime替代runc，用于在启动容器时自动挂载设备，对Containerd需要做的配置请参见[安装Ascend Docker Runtime](../05_developer_guide/00_installation_deployment/00_manual_installation/02_ascend_docker_runtime.md)章节的Containerd场景下安装Ascend Docker Runtime。
...
本章节介绍了集群调度组件用户指南中部分名词，方便用户更好地理解文档内容和步骤，名词介绍如[表1](#zh-cn_topic_0000001497364769_table163361144124517)所示。
...
>[!NOTE]
>更多关于集群调度组件支持的产品形态，请参见[支持的产品形态和OS清单](../01_introduction/03_supported_product_models_and_os.md)章节。
...
MindCluster集群调度组件是基于K8s生态的功能组件，因此训练任务调度基于K8s平台时才支持使用断点续训。断点续训支持的K8s版本与MindCluster集群调度组件一致，当前为1.17.x\~1.36.x（推荐使用1.21.x及以上版本）。
...
<div class="note" id="note989123811420"><a name="note989123811420"></a><a name="note989123811420"></a><span class="notetitle">[!NOTE] 说明</span><div class="notebody"><p id="p188918381649"><a name="p188918381649"></a><a name="p188918381649"></a>--auto-compaction-retention不会实际释放空间，需要用户手动配合使用etcdctl compact和etcdctl defrag清理空间。</p>
</div></div>
</td>
</tr>
...
请参见[开发者指南-自定义指标开发](../05_developer_guide/01_custom_metrics_development.md)。
...
- Kubernetes  1.24及以上版本，Dockershim已从Kubernetes项目中移除。如果用户还想继续使用Docker作为Kubernetes的容器引擎，需要再安装cri-dockerd，可参考[使用1.24及以上版本的Kubernetes时，Docker使用失败](https://gitcode.com/Ascend/mind-cluster/issues/340)章节进行操作。
- Kubernetes  1.25.10及以上版本，不支持虚拟化的vNPU的恢复功能。
