...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><p id="p1418212592323"><a name="p1418212592323"></a><a name="p1418212592323"></a><ul><li>取值为1：开启MindIO使能MindSpore开关。</li><li>取值不为1：关闭MindIO使能MindSpore开关。</li></ul></p>
</td>
</tr>
