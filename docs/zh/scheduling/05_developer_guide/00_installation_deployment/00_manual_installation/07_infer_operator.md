...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>查询<span>Infer Operator</span>版本号与commit ID等详细信息。</p><ul><li>true：查询。</li><li>false：不查询。</li></ul>
</td>
</tr>
