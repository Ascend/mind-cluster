...
8. （可选）在“volcano-v<i>\{version\}</i>.yaml“中，配置Volcano使用的集群调度组件为用户提供的重调度时删除Pod的模式、虚拟化方式、交换机亲和性调度、是否自维护可用芯片状态等。
    ...
    **表 3**  参数说明
    ...
    <div class="note" id="note1514175285210"><a name="note1514175285210"></a><a name="note1514175285210"></a><span class="notetitle">[!NOTE] 说明</span><div class="notebody"><a name="ul13842528165510"></a><a name="ul13842528165510"></a><ul id="ul13842528165510"><li>若设置的reserve-nodes大于等于super-pod-size时，存在以下场景。<ul><li>super-pod-size大于2，则默认重置reserve-nodes取值为2</li><li>super-pod-size小于或等于2，则默认重置reserve-nodes取值为0。</li></ul></li><li>当任务的调度策略为chip8-node8-ra64-sp时，reserve-nodes配置不生效。</li></ul>
    </div></div>
    </td>
    </tr>
