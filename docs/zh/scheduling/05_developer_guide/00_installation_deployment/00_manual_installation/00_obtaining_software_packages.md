...
|DPU Exporter|Ascend-mindxdl-dpu-exporter\_<i>{version}</i>\_linux-<i>{arch}</i>.zip| DPU Exporter软件包。|[获取链接](https://gitcode.com/Ascend/mind-cluster/releases/v26.2.0)|
...
|Volcano|Ascend-mindxdl-volcano\_<i>{version}</i>\_linux-<i>{arch}</i>.zip| Volcano软件包。Volcano包含volcano-controller和volcano-scheduler两个容器。<p>请根据K8s（Kubernetes）和开源Volcano的兼容性选择合适的版本进行安装，具体版本请参见[Volcano官网中对应的Kubernetes版本](https://github.com/volcano-sh/volcano/blob/master/README.md#kubernetes-compatibility)。</p><ul><li>Volcano v1.9.0兼容的K8s版本范围为1.21.x~1.29.x。</li><li>Volcano v1.12.0兼容的K8s版本范围为1.21.x~1.34.x。</li><li>Volcano v1.15.0兼容的K8s版本范围为1.24.x~1.35.x。</li></ul> |[获取链接](https://gitcode.com/Ascend/mind-cluster/releases/v26.1.0)|
...
|K8s RDMA Shared Dev Plugin|Ascend-mindxdl-k8s-rdma-shared-dev-plugin_<i>{version}</i>\_linux-<i>{arch}</i>.zip| K8s RDMA Shared Dev Plugin软件包。                                                                                                                                                                                                                                                                                                                                                           |[获取链接](https://gitcode.com/Ascend/mind-cluster/releases/v26.2.0)|
|Agent Core / Node Collector / Kubectl Plugin|Ascend-mindxdl-ascend-clusterops-agent_<i>{version}</i>\_linux.zip| Agent Core、Node Collector和Kubectl Plugin共用的软件包。|[获取链接](https://gitcode.com/Ascend/mind-cluster/releases/v26.2.0)|
...
>[!NOTE]
>Elastic Agent组件已经在7.3.0版本日落，请获取7.3.0之前版本的软件包。
...
|Agent Core|<https://gitcode.com/Ascend/mind-cluster/tree/master/component/ascend-clusterops-agent/agent-core>|
|Node Collector|<https://gitcode.com/Ascend/mind-cluster/tree/master/component/ascend-clusterops-agent/node-collector>|
|Kubectl Plugin|<https://gitcode.com/Ascend/mind-cluster/tree/master/component/ascend-clusterops-agent/kubectl-plugin>|
