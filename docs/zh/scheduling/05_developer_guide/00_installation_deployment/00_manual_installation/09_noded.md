...
- 使用慢节点&慢网络故障功能前，需安装NodeD，详细说明请参见[慢节点&慢网络故障](../../../04_usage/04_fault_detection_and_diagnosis/02_fault_types/05_performance_degradation.md#慢节点慢网络故障)。
...
5. 在管理节点的YAML所在路径，执行以下命令，启动NodeD。
    - 不使用[共享存储故障检测](../../../04_usage/04_fault_detection_and_diagnosis/02_fault_types/01_node_faults.md#节点故障)功能，请执行以下命令。
    ...
    - 如果需要使用[容器快照](../../../04_usage/10_infer_operator_best_practice/06_container_snapshot_usage.md#)功能，则执行以下命令，启动NodeD。
