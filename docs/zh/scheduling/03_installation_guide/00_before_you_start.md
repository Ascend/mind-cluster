...
Elastic Agent、TaskD和MindIO组件需部署在容器内，详细安装步骤请参见[制作镜像](../04_usage/04_resumable_training/04_examples_and_verification/01_pytorch_examples_and_verification.md#制作镜像)。
