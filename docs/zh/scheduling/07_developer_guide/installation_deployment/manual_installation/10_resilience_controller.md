...
- 使用**弹性训练**时，必须安装Resilience Controller。Resilience Controller连接K8s时，可以选择使用ServiceAccount或KubeConfig文件进行认证，两种方式差异可参考[使用ServiceAccount和KubeConfig差异](../../../06_references/appendix.md#使用serviceaccount和kubeconfig差异)。
