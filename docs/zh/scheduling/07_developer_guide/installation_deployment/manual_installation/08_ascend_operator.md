...
4. （可选）使用Ascend Operator为PyTorch和MindSpore框架下的训练任务生成集合通信配置文件（RankTable File，也叫[hccl.json](../../../05_api/hccl.json_file_description.md)文件），缩短集群通信建链时间。使用其他框架的用户，可跳过本步骤。
