...
1. 获取MindIE容器镜像。
    ...
    - 方式二：参考《MindIE安装指南》中的“安装MindIE \> [方式二：离线安装](https://www.hiascend.com/document/detail/zh/mindie/300/envdeployment/instg/docs/zh/user_guide/install/source/preparing_software_and_dependencies.md)”章节，自行准备镜像。
