...
用户已创建[hccl.json](../../api/hccl.json_file_description.md)文件的具体挂载路径，详细操作步骤请参见[Ascend Operator](../../installation_guide/02_installation/manual_installation/08_ascend_operator.md)中的“步骤4”。
