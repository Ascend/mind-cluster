...
- （必选）已[创建命名空间](../../installation_guide/02_installation/manual_installation/01_preparing_for_installation.md#创建命名空间)
- 在相应节点上完成以下组件的安装：[NodeD](../../installation_guide/02_installation/manual_installation/09_noded.md)（必选）、[Ascend Device Plugin](../../installation_guide/02_installation/manual_installation/04_ascend_device_plugin.md)（可选）、[ClusterD](../../installation_guide/02_installation/manual_installation/06_clusterd.md)（可选）
- （必选）已[配置NodeD启动参数resultMaxAge](../../installation_guide/02_installation/manual_installation/09_noded.md#参数说明)
...
- （可选）已安装[ClusterD](../../installation_guide/02_installation/manual_installation/06_clusterd.md)、[Ascend Device Plugin](../../installation_guide/02_installation/manual_installation/04_ascend_device_plugin.md)和[Volcano](../../installation_guide/02_installation/manual_installation/05_volcano.md)（以上MindCluster组件版本均需与TaskD配套）
...
当前仅支持与ClusterD和NodeD集成进行在线部署，请参见[安装部署](../../installation_guide/02_installation/manual_installation/00_obtaining_software_packages.md)章节完成ClusterD和NodeD部署。
