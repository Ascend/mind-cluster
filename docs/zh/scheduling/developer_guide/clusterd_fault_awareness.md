...
- 公共故障接口的完整API定义请参见[公共故障接口](../api/clusterd/03_public_fault_apis.md)。
- 配置公共故障的级别和发送方请参见[（可选）配置公共故障的级别和发送方](../usage/resumable_training/03_configuring_fault_detection_levels.md#可选配置公共故障的级别和发送方)。
