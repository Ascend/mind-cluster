...
本接口支持查询默认指标组和自定义指标组。自定义指标组的方法详细请参见[自定义指标开发](../../05_developer_guide/custom_metrics_development.md)；默认指标组包含如下几个部分。指标组的采集和上报由配置文件中的开关控制，若开关配置为开启，则对应的指标组会进行采集和上报；若开关配置为关闭，则对应的指标组不会进行采集和上报。
...
<div class="note" id="note71551511134616"><a name="note71551511134616"></a><a name="note71551511134616"></a><span class="notetitle">[!NOTE] 说明</span><div class="notebody"><a name="ul01551011174616"></a><a name="ul01551011174616"></a><ul id="ul01551011174616"><li>Prometheus场景：若该<span id="ph4155141154620"><a name="ph4155141154620"></a><a name="ph4155141154620"></a>昇腾AI处理器</span>上同时存在多个错误码，由于Prometheus格式限制，当前只支持上报前十个出现的错误码。X的取值范围：1~9</li><li>Telegraf场景：最多支持上报128个错误码。</li><li>错误码的详细说明，请参见<a href="../../07_references/appendix.md#芯片故障码参考文档">芯片故障码参考文档</a>章节。</li></ul>
</div></div>
</td>
