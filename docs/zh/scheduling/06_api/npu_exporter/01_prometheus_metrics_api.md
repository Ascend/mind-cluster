...
| utilization | container_npu_utilization | 带有容器信息的NPU的AICore利用率<br>**说明：**Telegraf不支持上报该指标 | [标签1](#table191895615241) | % | Atlas 训练系列产品<br>Atlas A2 训练系列产品<br>Atlas A3 训练系列产品<br>推理服务器（插Atlas 300I 推理卡）<br>Atlas 推理系列产品<br>Atlas 800I A2 推理服务器<br>A200I A2 Box 异构组件<br>Atlas 350 标卡<br>Atlas 850 系列硬件产品<br>Atlas 950 SuperPoD |
