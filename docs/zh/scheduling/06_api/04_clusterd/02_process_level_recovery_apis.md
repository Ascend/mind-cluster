...
**返回数据说明<a name="section10140143475520"></a>**
...
|返回值|类型（Protobuf定义）|说明|
|--|--|--|
|Status|message Status{<p>int32 code = 1;</p><p>string info = 2;</p>}|<p>**Status.code**：返回码。<ul><li>取值为0：表示故障恢复流程正常</li><li>其他值：表示故障恢复流程异常，并触发重调度。</li></ul></p><p>**Status.info**：返回信息描述。</p>|
