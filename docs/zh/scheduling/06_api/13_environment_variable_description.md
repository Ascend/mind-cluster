...
|RAS_NET_ROOT_PATH|用户配置|否|ClusterD和NodeD共享目录的根路径|在慢网络诊断场景下ClusterD和NodeD通过共享存储进行交互，详细请参见[慢网络诊断](../04_usage/11_fault_detection_and_diagnosis/02_fault_types/05_performance_degradation.md#慢网络诊断)|
...
<td class="cellrowborder" valign="top" width="23.189999999999998%" headers="mcps1.2.6.1.5 "><a name="ul695319973016"></a><a name="ul695319973016"></a><p id="ul695319973016">Master Pod对应svc的clusterIP。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p818275973217"><a name="p818275973217"></a><a name="p818275973217"></a>MindIO启动MindSpore开关。</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><p id="p1418212592323"><a name="p1418212592323"></a><a name="p1418212592323"></a><ul><li>取值为1：开启MindIO启动MindSpore开关。</li><li>取值不为1：关闭MindIO启动MindSpore开关。</li></ul></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p18182105963210"><a name="p18182105963210"></a><a name="p18182105963210"></a>MindSpore启动进程级恢复开关。</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><pre class="screen" id="screen15182185953212"><a name="screen15182185953212"></a><a name="screen15182185953212"></a>{TTP:1,UCE:1,ARF:1,HCCE:1,RSC:1}    # 字符串类型，分别开启临终遗言、<span id="ph15161018131912"><a name="ph15161018131912"></a><a name="ph15161018131912"></a>片上内存</span>故障的进程级在线恢复、进程级别重调度、网络故障的进程级在线恢复和Pod级别重调度</pre><div class="note"><span class="notetitle">[!NOTE] 说明</span><div class="notebody">上述字段的详细说明请参见<a href="https://www.mindspore.cn/docs/zh-CN/stable/api_python/env_var_list.html#%E4%B8%89%E6%96%B9%E5%BA%93">MindSpore文档</a>中“MS_ENABLE_TFT”环境变量。</div></div>
</td>
</tr>
</tbody>
</table>
...
## MindIO TFT环境变量说明<a name="section10131935156854"></a>

**表 7** MindIO TFT环境变量说明

<a name="table11131133598564"></a>
...
|MASTER_PORT|训练主节点通信端口，端口可配，若为非法值，使用默认值6000。|[1024, 65535]|-|
...
## MindIO ACP环境变量说明<a name="section10131935198741"></a>

**表 8** MindIO ACP环境变量说明

<a name="table11131133598741"></a>
