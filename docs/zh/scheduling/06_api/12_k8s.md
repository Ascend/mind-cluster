...
|<p>huawei.com/Ascend910-Recover</p><p>huawei.com/npu-Recover</p>|<term>Atlas 训练系列产品</term>故障恢复标识|故障芯片ID|Ascend Device Plugin|
|<p>huawei.com/Ascend910-NetworkRecover</p><p>huawei.com/npu-NetworkRecover</p>|<term>Atlas 训练系列产品</term>网络故障恢复标识|故障芯片ID|Ascend Device Plugin|
...
|<p>huawei.com/Ascend910</p><p>huawei.com/npu</p>|Ascend Device Plugin为Pod分配芯片的依据。具体的取值含义表示对应的是/dev/下的davinciX，<term>Ascend 950 系列产品</term>是NPU ID，其他产品是物理ID| 字符串                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |Volcano、Ascend Device Plugin|
...
|huawei.com/schedule_policy|指定调度策略。| 目前支持[表3 huawei.com/schedule\_policy配置说明](./01_volcano.md#podgroup)中的配置。                                                                                                                                                                                                                                                                                                                                                                                                                                                            |Volcano|
