...
|<p>huawei.com/Ascend910</p><p>huawei.com/npu</p>|Ascend Device Plugin为Pod分配芯片的依据。具体的取值含义表示对应的是/dev/下的davinciX，Ascend 950 系列产品是NPU ID，其他产品是物理ID| 字符串                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |Volcano、Ascend Device Plugin|
