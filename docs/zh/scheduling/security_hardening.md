...
- 新安装的设备，创建一个单独的分区，用于挂载“/var/lib/docker”目录，请参见[操作系统磁盘分区](./installation_guide/01_environment_dependencies.md#软硬件规格要求)。
...
>- 各组件配置文件的说明请参见[表1](developer_guide/installation_deployment/manual_installation/00_obtaining_software_packages.md)。
