...
- 若没有安装，可以参考[安装部署](developer_guide/installation_deployment/manual_installation/00_obtaining_software_packages.md)章节进行操作。
...
在具体操作前，用户需要参考[YAML配置说明](../../api/yaml_configuration.md#yaml_configuration)了解相关YAML示例的参数说明，再进行操作。
