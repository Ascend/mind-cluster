...
- Atlas 500 A2 智能小站预置的MEF服务会对Docker进行安全加固配置，Ascend Docker Runtime不支持在安全加固后的Docker环境下使用。若需要使用Ascend Docker Runtime，请手动卸载MEF服务，参考《MindEdge Framework 用户指南》中的“[卸载MEF Edge](https://gitcode.com/Ascend/MEF/blob/branch_v26.0.0/docs/zh/user_guide/installation_guide.md#%E5%8D%B8%E8%BD%BDmef-edge)”章节进行操作。
