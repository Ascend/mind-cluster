...
|RAS_NET_ROOT_PATH|用户配置|否|ClusterD和NodeD共享目录的根路径|在慢网络诊断场景下ClusterD和NodeD通过共享存储进行交互，详细请参见[慢网络诊断](../04_usage/resumable_training/01_solutions_principles.md#慢网络诊断)|
