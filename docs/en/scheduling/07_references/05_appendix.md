...
**Table 3** Default mount directories and files (Atlas 200I A2 accelerator module and Atlas 200I DK A2)
...
**Table 6** Default mount directories and files (Atlas 350 accelerator card)
...
<tbody><tr id="row326155119271"><td class="cellrowborder" rowspan="2" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p32614515273"><a name="p32614515273"></a><a name="p32614515273"></a><span id="ph1181011812299"><a name="ph1181011812299"></a><a name="ph1181011812299"></a>Atlas 800 training server (fully polulated with NPUs)</span></p>
...
<tr id="row1826951172711"><td class="cellrowborder" rowspan="2" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p826165112711"><a name="p826165112711"></a><a name="p826165112711"></a><span id="ph33362565317"><a name="ph33362565317"></a><a name="ph33362565317"></a>Atlas 800 training server (half-populated with NPUs)</span></p>
...
>[!NOTE]
>For more details on the products supported by cluster scheduling components, see [Supported Product Forms and OS List](../01_introduction/03_supported_product_models_and_os.md).
...
|URL|Description|
|--|--|
|huawei.com/Ascend910|Resource name for <term>Atlas training products</term>, not a URL, cannot be accessed.|
|huawei.com/Ascend310P|Resource name for <term>Atlas inference products</term>, not a URL, cannot be accessed.|
...
|huawei.com/Ascend310P-V|Resource name for <term>Atlas inference products</term> in mixed insertion mode: Atlas 300V video analysis card, not a URL, cannot be accessed.|
|huawei.com/Ascend310P-VPro|Resource name for <term>Atlas inference products</term> in mixed insertion mode: Atlas 300V Pro video analysis card, not a URL, cannot be accessed.|
|huawei.com/Ascend310P-IPro|Resource name for <term>Atlas inference products</term> in mixed insertion mode: Atlas 300I Pro inference card, not a URL, cannot be accessed.|
|huawei.com/npu|Resource name for <term>Ascend 950 products</term>, not a URL, cannot be accessed.|
...
<td class="cellrowborder" valign="top" width="41.675832416758325%" headers="mcps1.2.5.1.2 "><p id="p7151173693015"><a name="p7151173693015"></a><a name="p7151173693015"></a>The --quota-backend-bytes parameter is the storage limit for etcd, which defaults to 2GB.</p>
</td>
<td class="cellrowborder" valign="top" width="25.51744825517448%" headers="mcps1.2.5.1.3 "><p id="p7795115813293"><a name="p7795115813293"></a><a name="p7795115813293"></a>Modify to 8GB.</p>
...
<td class="cellrowborder" valign="top" width="25.51744825517448%" headers="mcps1.2.5.1.3 "><p id="p3821140192710"><a name="p3821140192710"></a><a name="p3821140192710"></a>Adjust the CPU resource limit for Volcano requests to 20 cores and the memory resource limit to 8GB.</p>
...
For details, see [Developer Guide - Custom Metric Development](../05_developer_guide/01_custom_metrics_development.md).
