...
This solution improves the training throughput of LLMs on the Ascend platform, with performance surpassing the [Microsoft Azure Nebula solution](https://learn.microsoft.com/azure/machine-learning/reference-checkpoint-performance-for-large-models?view=azureml-api-2&tabs=PYTORCH).
