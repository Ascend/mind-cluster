...
|--|--|--|
| Fault Detection | <p>Supports real-time monitoring of software and hardware faults in training scenarios.</p><p>For details on functions and principles, see [Fault Detection](./01_solutions_principles.md#fault-detection).</p> | [(Optional) Configuring Fault Detection Levels](./03_configuration/01_configuring_fault_detection_levels.md) |
| Fault Handling | <p>Automatically isolates faulty devices without manual intervention after a fault occurs.</p><p>For details on functions and principles, see [Fault Handling](./01_solutions_principles.md#fault-handling).</p> | [Configuring Fault Handling](./03_configuration/02_configuring_fault_handling_policies.md) |
| Recovery Acceleration | <p>Accelerates training recovery. You can customize acceleration policies to reduce training launch time.</p><p>For details on functions and principles, see [Recovery Acceleration](./01_solutions_principles.md#recovery-acceleration).</p> | [Configuring Recovery Acceleration](./03_configuration/03_configuring_training_recovery.md) |
...
- The resumable training feature is an advanced feature based on cluster scheduling components of MindCluster. For details about the preparations required before using this feature, see the [Preparing the Cluster Environment](./02_preparing_cluster_environment.md) section.
...
**Figure 4** Fault recovery phase<a name="zh-cn_topic_0000002003001306_fig13371418134510"></a>
