...
1. Modify the startup YAML of Ascend Device Plugin based on the fault handling mode used. The bold parts below indicate the modifications.
        ...
        ...
              ...
              - image: ascend-k8sdeviceplugin:v{version}
                ...
                args: [ "device-plugin
                         ...
                         <strong>-autoStowing=true                    # This field has been deprecated. Whether to enable automatic management switch; defaults to true. Setting to false disables automatic management, meaning that when a chip's health status changes from unhealthy to healthy, it will not be automatically added back to the schedulable resource pool. With automatic management disabled, when the chip's parameter-plane network fault is recovered, it will not be automatically added back to the schedulable resource pool. This feature only applies to <term>Atlas training products</term></strong>
                         <strong>-listWatchPeriod=5                   # Sets the health check interval; range [3,1800]; unit is seconds</strong>
    ...
    2. (Optional) Graceful fault tolerance mode (deprecated): Based on the rescheduling configuration, add the `-hotReset` field.

        >[!CAUTION]
        > **This feature has been deprecated. Do not use it!**
        >
        ...
        >- The following configuration examples are for historical reference only and are not recommended for use in production environments.
        ...
        ...
              ...
              - image: ascend-k8sdeviceplugin:v{version}
                ...
                args: [ "device-plugin
                         ...
                         -autoStowing=true                    # This field has been deprecated. Whether to enable automatic management switch; defaults to true. Setting to false disables automatic management, meaning that when a chip's health status changes from unhealthy to healthy, it will not be automatically added back to the schedulable resource pool. With automatic management disabled, when the chip's parameter-plane network fault is recovered, it will not be automatically added back to the schedulable resource pool. This feature only applies to <term>Atlas training products</term>
                         <span style="color:#D80000;"><strong>-hotReset=1 # [DEPRECATED] Enables graceful fault tolerance mode; the system will attempt to automatically reset the faulty chip (the online hot reset feature with a value of 1 has been deprecated)</strong></span>
                         -listWatchPeriod=5                   # Sets the health check interval; range [3,1800]; unit is seconds
                         -logFile=/var/log/mindx-dl/devicePlugin/devicePlugin.log
                         -logLevel=0" ]
                securityContext:
                  privileged: true
...
2. Run the following command on the K8s management node to start Ascend Device Plugin.
    ...
    ```shell
   # Replace {version} with the actual version number, for example, 26.1.0
...
>[!NOTE]
>The following example uses MindSpeed-LLM 26.1.0.
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002039339945_p19595310517"><a name="zh-cn_topic_0000002039339945_p19595310517"></a><a name="zh-cn_topic_0000002039339945_p19595310517"></a><a href="https://www.hiascend.com/en/developer/software/mindcluster/download?versionId=460&ids=53%2C154%2C%2C58%2C60%2C63%2C" target="_blank" rel="noopener noreferrer">Download Link</a></p>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002039339945_p1862053354"><a name="zh-cn_topic_0000002039339945_p1862053354"></a><a name="zh-cn_topic_0000002039339945_p1862053354"></a><a href="https://www.hiascend.com/en/developer/software/mindcluster/download?versionId=460&ids=53%2C154%2C%2C58%2C60%2C63%2C" target="_blank" rel="noopener noreferrer">Download Link</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002039339945_p87153755"><a name="zh-cn_topic_0000002039339945_p87153755"></a><a name="zh-cn_topic_0000002039339945_p87153755"></a><a href="https://www.hiascend.com/en/cann/download?versionId=791&ids=d806%2Ch0501%2Ch0601%2Ch0703" target="_blank" rel="noopener noreferrer">Download Link</a></p>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p19271154916428"><a name="p19271154916428"></a><a name="p19271154916428"></a><a href="https://www.hiascend.com/en/cann/download?versionId=791&ids=d806%2Ch0501%2Ch0601%2Ch0703" target="_blank" rel="noopener noreferrer">Download Link</a></p>
...
To prevent software packages from being maliciously tampered with during transmission or storage, you need to perform integrity verification when downloading software packages.

For TaskD and MindIO TTP verification, see [Package SUM Value Verification](../../05_developer_guide/00_installation_deployment/00_manual_installation/00_obtaining_software_packages.md#section51703441649). For other packages, see the [OpenPGP Signature Verification Guide](https://support.huawei.com/enterprise/en/doc/EDOC1100209376) to perform PGP digital signature verification on the software package downloaded from the Support website. If the verification fails, do not use the software package and contact Huawei technical support engineers for resolution.
...
2. Write the following Dockerfile.
    ...
    RUN useradd -d /home/HwHiAiUser -u 1000 -m -s /bin/bash
    # Install torch, TorchNPU, and apex packages
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><p id="zh-cn_topic_0000002003180012_p_hyperparallel_required"><a name="zh-cn_topic_0000002003180012_p_hyperparallel_required"></a><a name="zh-cn_topic_0000002003180012_p_hyperparallel_required"></a>Yes</p>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p_hyperparallel_desc"><a name="zh-cn_topic_0000002003180012_p_hyperparallel_desc"></a><a name="zh-cn_topic_0000002003180012_p_hyperparallel_desc"></a>An Ascend SuperPoD-affinity distributed parallel acceleration library.</p>
</td>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p439011371714"><a name="zh-cn_topic_0000002003180012_p439011371714"></a><a name="zh-cn_topic_0000002003180012_p439011371714"></a>Since installing MindSpore via pip may cause dependency installation errors, dependencies can be installed first.</p>
</td>
...
<div class="note" id="zh-cn_topic_0000002003180012_note14449193224617"><a name="zh-cn_topic_0000002003180012_note14449193224617"></a><a name="zh-cn_topic_0000002003180012_note14449193224617"></a><span class="notetitle">Note</span><div class="notebody"><p id="zh-cn_topic_0000002003180012_p15449133274617"><a name="zh-cn_topic_0000002003180012_p15449133274617"></a><a name="zh-cn_topic_0000002003180012_p15449133274617"></a>MindSpore package should be used together with<span id="zh-cn_topic_0000002003180012_ph327965117217"><a name="zh-cn_topic_0000002003180012_ph327965117217"></a><a name="zh-cn_topic_0000002003180012_ph327965117217"></a><term>Atlas training products</term></span>. For version mapping, see <a href="https://www.mindspore.cn/install/en" target="_blank" rel="noopener noreferrer">MindSpore Installation Guide</a>.</p>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p1839181315178"><a name="zh-cn_topic_0000002003180012_p1839181315178"></a><a name="zh-cn_topic_0000002003180012_p1839181315178"></a>MindSpore whl package.</p><p>The "cp3x" in the package name indicates the Python version, e.g., "x=10" means Python 3.10; select the appropriate package based on the actual environment.</p>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p6391181310177"><a name="zh-cn_topic_0000002003180012_p6391181310177"></a><a name="zh-cn_topic_0000002003180012_p6391181310177"></a><a href="https://www.mindspore.cn/install/en" target="_blank" rel="noopener noreferrer">Download Link</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p11392111316172"><a name="zh-cn_topic_0000002003180012_p11392111316172"></a><a name="zh-cn_topic_0000002003180012_p11392111316172"></a><a href="https://www.hiascend.com/en/developer/software/mindcluster/download?versionId=460&ids=53%2C154%2C%2C58%2C60%2C63%2C" target="_blank" rel="noopener noreferrer">Download Link</a></p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><p id="zh-cn_topic_0000002003180012_p1139314132170"><a name="zh-cn_topic_0000002003180012_p1139314132170"></a><a name="zh-cn_topic_0000002003180012_p1139314132170"></a>Yes</p><p>For versions earlier than CANN 8.5.0, this package is named Ascend-cann-kernels-<em>{chip_type}</em>_<em>{version}</em>_linux-<em>{arch}</em>.run.</p>
</td>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p139312131171"><a name="zh-cn_topic_0000002003180012_p139312131171"></a><a name="zh-cn_topic_0000002003180012_p139312131171"></a><a href="https://www.hiascend.com/en/cann/download?versionId=791&ids=d806%2Ch0501%2Ch0601%2Ch0703" target="_blank" rel="noopener noreferrer">Download Link</a></p>
<div class="note" id="zh-cn_topic_0000002003180012_note13501612171513"><a name="zh-cn_topic_0000002003180012_note13501612171513"></a><a name="zh-cn_topic_0000002003180012_note13501612171513"></a><span class="notetitle">Note</span><div class="notebody"><p id="zh-cn_topic_0000002003180012_p1519161921516"><a name="zh-cn_topic_0000002003180012_p1519161921516"></a><a name="zh-cn_topic_0000002003180012_p1519161921516"></a>Please obtain the software package that matches the server model.</p>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p239319132175"><a name="zh-cn_topic_0000002003180012_p239319132175"></a><a name="zh-cn_topic_0000002003180012_p239319132175"></a><a href="https://www.hiascend.com/en/cann/download?versionId=791&ids=d806%2Ch0501%2Ch0601%2Ch0703" target="_blank" rel="noopener noreferrer">Download Link</a></p>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p4825711171415"><a name="zh-cn_topic_0000002003180012_p4825711171415"></a><a name="zh-cn_topic_0000002003180012_p4825711171415"></a>Resume training component whl package.</p>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p18169645192413"><a name="zh-cn_topic_0000002003180012_p18169645192413"></a><a name="zh-cn_topic_0000002003180012_p18169645192413"></a><a href="https://www.hiascend.com/en/developer/software/mindcluster/download?versionId=460&ids=53%2C154%2C%2C58%2C60%2C63%2C" target="_blank" rel="noopener noreferrer">Download Link</a></p>
<div class="note" id="zh-cn_topic_0000002003180012_note079418496154"><a name="zh-cn_topic_0000002003180012_note079418496154"></a><a name="zh-cn_topic_0000002003180012_note079418496154"></a><span class="notetitle">Note</span><div class="notebody"><a name="zh-cn_topic_0000002003180012_ul79293962319"></a><a name="zh-cn_topic_0000002003180012_ul79293962319"></a><ul id="zh-cn_topic_0000002003180012_ul79293962319"><li>In MindSpore scenarios, this whl package must be installed to use graceful fault tolerance, Pod-level rescheduling, process-level rescheduling, and process-level online recovery.</li><li>The download link provides<span id="zh-cn_topic_0000002003180012_ph11742444163719"><a name="zh-cn_topic_0000002003180012_ph11742444163719"></a><a name="zh-cn_topic_0000002003180012_ph11742444163719"></a>a TaskD</span> compressed package: Ascend-mindxdl-taskd_<em id="i112838253389"><a name="i112838253389"></a><a name="i112838253389"></a>{version}</em>_linux-<em id="i1328312515383"><a name="i1328312515383"></a><a name="i1328312515383"></a>{arch}</em>.zip. The corresponding whl package must be obtained after extracting the archive.</li></ul>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p73942134170"><a name="zh-cn_topic_0000002003180012_p73942134170"></a><a name="zh-cn_topic_0000002003180012_p73942134170"></a>Driver information file.</p>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p239415135179"><a name="zh-cn_topic_0000002003180012_p239415135179"></a><a name="zh-cn_topic_0000002003180012_p239415135179"></a>Copy "/usr/local/Ascend/driver/version.info" from the host.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p03941613151715"><a name="zh-cn_topic_0000002003180012_p03941613151715"></a><a name="zh-cn_topic_0000002003180012_p03941613151715"></a>Driver information file.</p>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0000002003180012_p11394141321712"><a name="zh-cn_topic_0000002003180012_p11394141321712"></a><a name="zh-cn_topic_0000002003180012_p11394141321712"></a>Copy "/etc/ascend_install.info" from the host.</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p63959135172"><a name="zh-cn_topic_0000002003180012_p63959135172"></a><a name="zh-cn_topic_0000002003180012_p63959135172"></a>Used to install the pip module.</p>
</td>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.3 "><p id="zh-cn_topic_0000002003180012_p639719136172"><a name="zh-cn_topic_0000002003180012_p639719136172"></a><a name="zh-cn_topic_0000002003180012_p639719136172"></a>Required for building images.</p>
</td>
...
For details, see [Official Verl Documentation - Building an Image](https://github.com/verl-project/verl/blob/b97ebfd5062223337ae065c2250f8ab5c0e08e5e/docs/ascend_tutorial/dockerfile_build_guidance.rst). vLLM and Megatron serve as the inference and training backends, respectively.

**Install Software**

For details, see [Official Verl Documentation - Installing Software](https://github.com/verl-project/verl/blob/b97ebfd5062223337ae065c2250f8ab5c0e08e5e/docs/ascend_tutorial/ascend_quick_start.rst).
...
>- The displayed component code for resumable training is open-source code. For related security instructions, see [Security Statement](../../07_references/05_appendix.md#security-statement).
...
For training code and dataset preparation, see [MindSpeed-LLM User Guide](https://gitcode.com/Ascend/MindSpeed-LLM/blob/26.1.0/docs/en/pytorch/training/pretrain/mcore/pretrain.md). The following uses two Atlas 800T A2 training servers as an example to describe the specific operation steps.
...
6. Obtain the [training job YAML](https://gitcode.com/Ascend/mindcluster-deploy/blob/master/samples/train/resumable-training/fault-tolerance/without-ranktable/pytorch/Qwen3/yamls/pytorch_multinodes_acjob_910b.yaml). This YAML has already configured pod-level rescheduling, process-level rescheduling, process-level online recovery, elastic training, and more. Set the IP address of the server to which the volume is mounted and rescheduling levels as required.
    ...
    Training process recovery functions such as process-level rescheduling, process-level online recovery, and elastic training cannot coexist with graceful fault tolerance. For details about how to configure graceful fault tolerance, see [Graceful Fault Tolerance Mode](#graceful-fault-tolerance-mode-deprecated).
...
7. Configure `train_start.sh` and the training job YAML based on the actual situation.
    ...
    2. To use TaskD for process-level rescheduling, process-level online recovery, process-level in-place recovery, or elastic training, you also need to start TaskD Manager.
        1. Create a `manager.py` file in the current directory when calling the training script. The content of the `manager.py` file is as follows.
            ...
            >[!NOTE]
            >For detailed description of parameters in the manager.py file, see [def init_task_manager(config:dict) -> bool:](../../06_api/07_taskd/04_taskd_manager_apis.md#def-init_taskd_managerconfigdict---bool).
...
1. Prepare the code.
    ...
    cd ..
    # Rename mindformers as QWEN3_for_MS_code
...
4. Obtain the [training job YAML](https://gitcode.com/Ascend/mindcluster-deploy/blob/master/samples/train/resumable-training/fault-tolerance/ranktable/mindspore/Qwen3/yamls/ms_multinodes_acjob_superpod.yaml) and the [training launch script](https://gitcode.com/Ascend/mindcluster-deploy/blob/master/samples/train/resumable-training/fault-tolerance/ranktable/mindspore/Qwen3/msrun_launcher.sh), and modify them.
    ...
    3. To use TaskD for process-level rescheduling, process-level online recovery, process-level in-place recovery, suspension and switchback of cross-rail communication tasks, or online stress testing, you also need to start TaskD Manager.
        1. Create a `manager.py` file and place it in the current directory when calling the training script. The content of the `manager.py` file is as follows.
            ...
            >**NOTE**
            >For details about the parameters in the manager.py file, see [def init_taskd_manager(config:dict) -> bool:](../../06_api/07_taskd/04_taskd_manager_apis.md#def-init_taskd_managerconfigdict---bool).
...
5. Modify the parameter model configuration file.
...
MindCluster only supports Job-level and Pod-level rescheduling for the Verl framework, where Pod-level rescheduling only supports the GRPO algorithm.
Verl's training jobs are managed by a Ray cluster. To adapt to MindCluster's Ascend Job deployment, one Pod is deployed on each Worker node, and the Pod hosts all processes on that Ray cluster.
Currently, MindCluster supports separate deployment of Verl's master and worker nodes. The head node of the Ray cluster serves as the Master Pod, which starts the Ray cluster. After other Worker Pods are started, they join the Ray cluster, and then the head node submits jobs.
...
After startup, error messages similar to the following may appear in the logs. This is normal because the head node usually does not have NPU mounted.
...
>    huawei.com/schedule_policy: "chip2-node16-sp"    # Set scheduling policy based on the hardware form.
>...
>```
...
### Graceful Fault Tolerance Mode (Deprecated)<a name="ZH-CN_TOPIC_0000002511346479"></a>
...
Training logs of the restarted training process are stored in `{training_script_path}/newlog`, with details as follows.
