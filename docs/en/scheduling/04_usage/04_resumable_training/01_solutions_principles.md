...
|--|--|--|
|Atlas training products|<ul><li>Atlas 800 training server (model 9000)</li><li>Atlas 800 training server (model 9010)</li></ul><div class="note"><span class="notetitle">[!NOTE]</span><div class="notebody">If the chip work mode of the Atlas 800 training server is SMP and the number of requested NPUs by each Pod is 1 or 2, rescheduling is not supported. For details about how to query and set the NPU chip work mode, see [Querying and Setting NPU Chip Work Mode (npuworkmode)](https://support.huawei.com/enterprise/en/doc/EDOC1100136583/b6e6ed5a) in *Atlas 800 Training Server iBMC User Guide (Model 9000)*.</div></div>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Atlas A2 training products|<ul><li>Atlas 800T A2 training server</li><li>Atlas 200T A2 Box16 heterogeneous subrack</li><li>Atlas 900 A2 PoD cluster basic unit</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Atlas A3 training products|<ul><li>Atlas 900 A3 SuperPoD</li><li>Atlas 800T A3 SuperPoD server</li><li>Atlas 9000 A3 SuperPoD cluster computing system</li><li>A200T A3 Box8 SuperPoD server</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Ascend 950 products|<ul><li>Atlas 950 SuperPoD</li><li>Atlas 850E SuperPoD</li><li>Atlas 650E server</li></ul>|PyTorch|
...
|--|--|--|
|Atlas A2 training products|<ul><li>Atlas 800T A2 training server</li><li>Atlas 200T A2 Box16 heterogeneous subrack</li><li>Atlas 900 A2 PoD cluster basic unit</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Atlas A3 training products|<ul><li>Atlas 900 A3 SuperPoD</li><li>Atlas 800T A3 SuperPoD server</li><li>Atlas 9000 A3 SuperPoD cluster computing system</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Ascend 950 products|Atlas 950 SuperPoD|PyTorch|
...
|Product Type|Hardware Form Factor|Training Framework|
|--|--|--|
|Atlas A2 training products|<ul><li>Atlas 800T A2 training server</li><li>Atlas 900 A2 PoD cluster basic unit</li><li>Atlas 900 A2 PoDc cluster basic unit</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Atlas A3 training products|<ul><li>Atlas 900 A3 SuperPoD</li><li>Atlas 800T A3 SuperPoD server</li><li>Atlas 9000 A3 SuperPoD cluster computing system</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Ascend 950 products|Atlas 950 SuperPoD|PyTorch|
...
|--|--|--|
|Atlas A3 training products|<ul><li>Atlas 900 A3 SuperPoD</li><li>Atlas 9000 A3 SuperPoD cluster computing system</li></ul>|-|
...
|Product Type|Hardware Form|Training Framework|
|--|--|--|
|Atlas A3 training products|<ul><li>Atlas 900 A3 SuperPoD</li><li>Atlas 800T A3 SuperPoD server</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
...
|Atlas A2 training products|<ul><li>Atlas 800T A2 training server</li><li>Atlas 900 A2 PoD cluster basic unit</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Atlas A3 training products|<ul><li>Atlas 900 A3 SuperPoD</li><li>Atlas 800T A3 SuperPoD server</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
...
|Product Type|Hardware Form|Training Framework|
|--|--|--|
|Atlas A2 training products|Atlas 800T A2 training server|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
...
|--|--|--|
|Atlas A2 training products|Atlas 800T A2 training server|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
|Atlas A3 training products|<ul><li>Atlas 800T A3 SuperPoD server</li><li>Atlas 9000 A3 SuperPoD cluster computing system</li></ul>|<ul><li>MindSpore</li><li>PyTorch</li></ul>|
