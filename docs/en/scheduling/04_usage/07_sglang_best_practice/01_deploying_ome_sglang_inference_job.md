...
For detailed instructions, see the [OME documentation](https://ome-projects.github.io/ome/docs/) and [LWS documentation](https://github.com/kubernetes-sigs/lws/blob/v0.10.0/docs/examples/sample/gang-scheduling/README.md).
