...
- Before using the resource monitoring feature, ensure that NPU Exporter has been installed. If it is not installed, see [Installation and Deployment](../../03_installation_guide/02_installation/00_helm_installation.md) for instructions.
