...
<!-- md-trans-meta sourceCommit=a277c409db3c3340f95d7c4831c0d54fa24e71a7 translatedAt=2026-08-28T08:18:35.294Z pushedAt=2026-08-28T08:38:32.782Z -->

The HDK-based virtual instance function refers to partitioning the NPU configured on a physical machine or virtual machine into multiple virtual NPUs (vNPUs) through resource virtualization, and mounting them to containers for use.

The HDK-based virtual instance function offers the following advantages:

- **Lower usage threshold and cost**: Multiple users can apply for resources on demand and share the computing power of a single NPU.
- **Good resource isolation**: Resource isolation is achieved through containers, ensuring the stability and security of the runtime environment.

## Principle Introduction<a name="section154002962818"></a>

Ascend NPU hardware resources mainly include AICore (used for AI model computation), AICPU, and memory. The core principle of the HDK-based virtual instance function is to partition the above hardware resources into vNPUs according to the resource requirements specified by the user. Each vNPU corresponds to a certain number of AICores, AICPUs, memory, DVPP, and other resources. For example, when a user needs only 4 AICores of computing power, the system creates a vNPU and allocates 4 AICores from the NPU to a container through that vNPU. The HDK-based virtualization instance solution is shown in [Figure 1](#fig987114711574).

**Figure 1** HDK-based virtual instance solution<a name="fig987114711574"></a>

![](../../../../figures/scheduling/hdk-based-virtual-instance-solution.PNG)

## Product Support Description<a name="section17326115542216"></a>
...
<th class="cellrowborder" valign="top" width="33.339999999999996%" id="mcps1.2.5.1.2"><p id="p7669919322"><a name="p7669919322"></a><a name="p7669919322"></a>Supported Scenario</p>
</th>
<th class="cellrowborder" valign="top" width="21.87%" id="mcps1.2.5.1.3"><p id="p127814159230"><a name="p127814159230"></a><a name="p127814159230"></a>Virtualization Method</p>
</th>
...
<tbody><tr id="row147414361945"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p1842320153510"><a name="p1842320153510"></a><a name="p1842320153510"></a><span id="ph118421720103512"><a name="ph118421720103512"></a><a name="ph118421720103512"></a>Atlas inference products</span></p>
...
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p11251183411474"><a name="p11251183411474"></a><a name="p11251183411474"></a>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
...
<tr id="row798113134910"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p52561887496"><a name="p52561887496"></a><a name="p52561887496"></a><span id="ph32565816491"><a name="ph32565816491"></a><a name="ph32565816491"></a>Atlas inference products</span></p>
...
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p152563874915"><a name="p152563874915"></a><a name="p152563874915"></a>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
...
<tr id="row1327811510231"><td class="cellrowborder" rowspan="3" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p1868751772016"><a name="p1868751772016"></a><a name="p1868751772016"></a><span id="ph20484134417286"><a name="ph20484134417286"></a><a name="ph20484134417286"></a>Atlas inference products</span></p>
...
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p85154811485"><a name="p85154811485"></a><a name="p85154811485"></a>Partition vNPUs on the physical machine and mount the vNPUs to the virtual machine.</p>
</td>
...
<tr id="row11765455154717"><td class="cellrowborder" valign="top" headers="mcps1.2.5.1.1 "><p id="p1470994219485"><a name="p1470994219485"></a><a name="p1470994219485"></a>Partition vNPUs on the physical machine, mount the vNPUs to the virtual machine, and mount the vNPUs to containers within the virtual machine.</p>
</td>
...
<tr id="row258393195019"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p8957191110518"><a name="p8957191110518"></a><a name="p8957191110518"></a><span id="ph3957151113515"><a name="ph3957151113515"></a><a name="ph3957151113515"></a>Atlas inference products</span></p>
...
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p10669161183218"><a name="p10669161183218"></a><a name="p10669161183218"></a>Partition vNPUs on the physical machine and mount the vNPUs to virtual machines</p>
</td>
...
<tr id="row2010035054514"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p510014508453"><a name="p510014508453"></a><a name="p510014508453"></a><span id="ph327965117217"><a name="ph327965117217"></a><a name="ph327965117217"></a>Atlas training products</span></p>
...
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p710095010451"><a name="p710095010451"></a><a name="p710095010451"></a>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
...
<tr id="row32781215162311"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p162786153239"><a name="p162786153239"></a><a name="p162786153239"></a><span id="ph151431757142112"><a name="ph151431757142112"></a><a name="ph151431757142112"></a>Atlas A2 training products</span></p>
<ul><li><span>Atlas 800T A2 training server (24 AICores)</span></li></ul>
</td>
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p366920193216"><a name="p366920193216"></a><a name="p366920193216"></a>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
...
<tr id="row11243152011236"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p18243192015230"><a name="p18243192015230"></a><a name="p18243192015230"></a><span id="ph18411121792018"><a name="ph18411121792018"></a><a name="ph18411121792018"></a>Atlas A3 training products</span></p>
<ul><li><span>Atlas 800T A3 SuperPoD server</span></li></ul>
</td>
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p82441020122317"><a name="p82441020122317"></a><a name="p82441020122317"></a>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
<td class="cellrowborder" valign="top" width="21.87%" headers="mcps1.2.5.1.3 "><ul><li>Static virtualization</li><li>Dynamic virtualization</li></ul>
</td>
...
<tr id="row18359185713363"><td class="cellrowborder" valign="top" width="31.78%" headers="mcps1.2.5.1.1 "><p id="p18176151918"><a name="p18176151918"></a><a name="p18176151918"></a><span id="ph996833614580"><a name="ph996833614580"></a><a name="ph996833614580"></a>Atlas A2 inference products</span></p>
<ul><li><span>Atlas 800I A2 inference server</span></li></ul>
</td>
<td class="cellrowborder" valign="top" width="33.339999999999996%" headers="mcps1.2.5.1.2 "><p id="p1035910576364"><a name="p1035910576364"></a><a name="p1035910576364"></a>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
<td class="cellrowborder" valign="top" width="21.87%" headers="mcps1.2.5.1.3 "><ul><li>Static virtualization</li><li>Dynamic virtualization</li></ul>
</td>
...
<tr><td><p><span>Atlas A3 inference products</span></p>
<ul><li><span>Atlas 800I A3 SuperPoD server</span></li></ul>
</td>
<td><p>Partition vNPUs on the physical machine and mount the vNPUs to containers</p>
</td>
...
- Static virtualization and dynamic virtualization are implemented based on HDK. After the NPU is partitioned into vNPUs through the HDK interface, the vNPUs are mounted to containers for use.
- If you need dynamic virtualization, directly refer to the [Dynamic vNPU Scheduling](./05_dynamic_vnpu_scheduling/01_dynamic_vnpu_scheduling_inference.md) section. You do not need to create vNPUs using the `npu-smi` command in advance.
- If you need static virtualization, first [Creating vNPUs](./04_static_vnpu_scheduling/01_creating_vnpu.md), and then mount the vNPUs to containers.

## Usage Constraints<a name="section911013420264"></a>

- After a physical NPU is virtualized into vNPUs, the physical NPU can no longer be mounted to a container for use, nor can it be passed through to a virtual machine for use.
- A vNPU can be used by only one task container. Multiple task containers are not supported to use the same vNPU.
- The working modes of the two chips on the Atlas 300I Duo inference card must be consistent. That is, both chips must use the virtual instance function, or both must use the entire card. Plan this according to your service requirements.
- The virtual instance template is used to partition resources of all NPUs on the entire server. Mixing standard cards of different specifications is not supported. For example, the Atlas 300V Pro video analysis card supports 24 GB and 48 GB memory specifications, but mixing cards of these two memory specifications for virtualization is not supported. Mixing <term>Atlas training products</term> with 30 AICores and <term>Atlas training products</term> with 32 AICores is also not supported.
- When the server is an Atlas training product, the virtualization function is supported only when the NPU chip works in AMP mode, and SMP mode is not supported. The procedure for query and configuration of the NPU chip working mode is as follows (ensure that the server operating system is powered off):

    1. Log in to the iBMC command line.
    2. Run the **ipmcget -d npuworkmode** command to query the working mode of the NPU chip. If it is AMP mode, no switching is required.
    3. Run the **ipmcset -d npuworkmode -v 0** command to set the working mode of the NPU chip to AMP mode.

    For details about query and configuration of the NPU chip working mode, see the "[Querying and Setting the NPU Chip Working Mode (npuworkmode)](https://support.huawei.com/enterprise/en/doc/EDOC1100136580/51fd0a0/querying-and-setting-the-npu-chip-working-mode-npuworkmode?idPath=23710424|251366513|22892968|252309113|250702818)" section in *[Atlas 800 Training Server iBMC User Guide (Model 9000)](https://support.huawei.com/enterprise/en/doc/EDOC1100136580/426cffd9/about-this-document?idPath=23710424|251366513|22892968|252309113|250702818)*.
