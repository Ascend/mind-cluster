...
<table><thead align="left"><tr id="row16723873015"><th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.1"><p id="p871338103019"><a name="p871338103019"></a><a name="p871338103019"></a>Supported Scenario for Ascend Virtual Instance</p>
</th>
<th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.2"><p id="p14014521402"><a name="p14014521402"></a><a name="p14014521402"></a>Procedure</p>
</th>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><a name="ol4232523123116"></a><a name="ol4232523123116"></a><ol id="ol4232523123116"><li>For the steps to partition vNPUs on the physical machine, see <a href="./04_static_vnpu_scheduling/01_creating_vnpu.md">Creating vNPUs</a>.</li><li>For the steps to mount vNPUs to the container, see <a href="./04_static_vnpu_scheduling/02_mounting_vnpu_static.md">Mounting vNPUs (Static Virtualization)</a> or <a href="./05_dynamic_vnpu_scheduling/01_dynamic_vnpu_scheduling_inference.md">Dynamic vNPU Scheduling</a>.</li></ol>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><ul><li>Static Virtualization</li><li>Dynamic Virtualization</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.2 "><a name="ol441318447318"></a><a name="ol441318447318"></a><ol id="ol441318447318"><li>Passthrough NPU to a VM on the physical machine.</li><li>For the steps to partition vNPU within the VM, see <a href="./04_static_vnpu_scheduling/01_creating_vnpu.md">Creating vNPUs</a>.</li><li>For the steps to mount vNPUs to containers within the virtual machine, see <a href="./04_static_vnpu_scheduling/02_mounting_vnpu_static.md">Mounting vNPUs (Static Virtualization)</a> or <a href="./05_dynamic_vnpu_scheduling/01_dynamic_vnpu_scheduling_inference.md">Dynamic vNPU Scheduling</a>.</li></ol>
</td>
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><ul><li>Static Virtualization</li><li>Dynamic Virtualization</li></ul>
</td>
</tr>
...
## vNPU Mounting to Containers<a name="section84114107544"></a>
