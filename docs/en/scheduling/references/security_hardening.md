...
>- For descriptions of each component's configuration file, see [Table 1](../developer_guide/installation_deployment/manual_installation/00_obtaining_software_packages.md).
