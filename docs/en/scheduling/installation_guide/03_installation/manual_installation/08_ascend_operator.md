...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p id="p3537285549"><a name="p3537285549"></a><a name="p3537285549"></a>Whether to enable "gang" policy scheduling. It is enabled by default. When enabled, task scheduling is performed based on the scheduler specified by the task. For details about "gang" policy scheduling, see the <a href="https://volcano.sh/docs/v1.9.0/Scheduler/Plugins" target="_blank" rel="noopener noreferrer">open-source Volcano official documentation</a>.</p>
