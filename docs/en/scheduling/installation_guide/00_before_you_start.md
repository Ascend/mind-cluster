...
- For log paths of other cluster scheduling components, see [Creating Log Directories](../installation_guide/03_installation/manual_installation/01_preparing_for_installation.md#creating-log-directories).
