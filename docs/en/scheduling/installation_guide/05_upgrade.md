...
1. Download the new version of the component installation package. For details, see the [Obtain Software Packages](./03_installation/manual_installation/00_obtaining_software_packages.md) chapter.
...
5. <a name="li76002022113215"></a>Refer to the [Component Status](./04_confirming_status.md) chapter to check whether the new version of Ascend Docker Runtime has been upgraded successfully.
...
1. Refer to the [Obtain Software Packages](./03_installation/manual_installation/00_obtaining_software_packages.md) chapter to download the new version of the component installation package.
...
1. Refer to the [Preparing Image](./03_installation/manual_installation/01_preparing_for_installation.md#preparing-an-image) chapter and use the new software package to create the image.
...
1. Refer to the [Obtain Software Packages](./03_installation/manual_installation/00_obtaining_software_packages.md) chapter to download the new version of the TaskD installation package.
