...
1. Go to the [mindcluster-deploy](https://gitcode.com/Ascend/mindxdl-deploy) repository, switch to the corresponding branch according to the [mindcluster-deploy Open-Source Repository Version Description](../../appendix.md#mindcluster-deploy-open-source-repository-version-description), and obtain the `prometheus.yaml` file in the `samples/utils/prometheus/base` directory.
...
3. Install Prometheus.
    1. <a name="li601241164212"></a>Go to the [mindcluster-deploy](https://gitcode.com/Ascend/mindxdl-deploy) repository, switch to the corresponding branch according to [mindcluster-deploy Open-Source Repository Version Description](../../appendix.md#mindcluster-deploy-open-source-repository-version-description), and obtain the `prometheus.yaml` file from the `samples/utils/prometheus/base` directory.
