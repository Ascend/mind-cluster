...
- Before using the resource monitoring feature, ensure that NPU Exporter has been installed. If it is not installed, see [Installation and Deployment](../../developer_guide/installation_deployment/manual_installation/00_obtaining_software_packages.md) for instructions.
