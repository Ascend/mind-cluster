...
Currently, the vLLM Proxy-based Infer Operator inference job is deployed using the `InferServiceSet`-customized CRD. For Infer Operator deployment, see [Installation and Deployment](../../developer_guide/installation_deployment/manual_installation/07_infer_operator.md).
