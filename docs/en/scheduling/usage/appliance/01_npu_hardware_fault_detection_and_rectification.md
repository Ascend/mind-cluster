...
In scenarios without K8s, there is no effective recovery method after a training or inference process becomes abnormal. To address this issue, you can configure the container recovery feature. To support the container recovery feature, you need to install Container Manager. For details on installing Container Manager, see [Installation and Deployment](../../installation_guide/03_installation/manual_installation/00_obtaining_software_packages.md).
...
>[!NOTE]
>
>- For information corresponding to each fault, see [Chip Fault Code Reference](../../appendix.md#chip-fault-code-references).
