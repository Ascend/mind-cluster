...
Resumable training can be built based on the base training image. For details on building the base training image, see the [Building a Container Image Using Dockerfile (PyTorch)](../../common_operations.md#building-a-container-image-using-dockerfile-pytorch) section.
