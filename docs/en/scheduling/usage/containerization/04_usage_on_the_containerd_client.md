...
- Ascend Docker Runtime supports mounting physical chips and virtual chips. Before mounting virtual chips, refer to the [Creating vNPUs](../virtual_instance/virtual_instance_with_hdk/04_creating_vnpu.md) section to virtualize physical chips. Both static virtualization and dynamic virtualization of physical chips are supported.
