...
- If not installed, refer to the [Installation and Deployment](../../installation_guide/03_installation/manual_installation/00_obtaining_software_packages.md) section for the operation.
...
- (Optional) If you require a more personalized inference environment, you can [modify the downloaded base inference image using a Dockerfile](../../common_operations.md).
...
The downloaded or created base inference image can be security hardened to improve image security. See the [Container Security Hardening](../../security_hardening.md#container-security-hardening) section for operation steps.
