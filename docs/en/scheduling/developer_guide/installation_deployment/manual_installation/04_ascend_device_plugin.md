...
|-getPodFromKubelet|bool|true|Whether to obtain Pod information from kubelet instead of the API server.<ul><li>true: Obtain Pod information from kubelet.</li><li>false: Obtain Pod information from the API server.</li></ul>|
