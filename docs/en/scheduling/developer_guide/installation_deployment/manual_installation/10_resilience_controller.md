...
- To use elastic training, Resilience Controller must be installed. When Resilience Controller connects to K8s, you can choose to authenticate using a ServiceAccount or a KubeConfig file. For differences between the two methods, see [Differences Between ServiceAccount and KubeConfig](../../../references/appendix.md).
