# Supported Products and OSs

<!-- md-trans-meta sourceCommit=unknown translatedAt=2026-06-09T02:19:11.710Z pushedAt=2026-06-09T06:22:07.014Z -->

The products supported by management nodes, compute nodes, and storage nodes in a cluster scenario vary; the products supported by compute nodes are consistent with those supported in the single-server scenario.

## Cluster Scenario

- Management node: Supports multiple types of servers, such as TaiShan 200 server (model 2280), FusionServer Pro 2288H V5, etc.
- Compute node: The supported products are consistent with those supported in the single-server scenario. See the table below.
- Storage node: storage server.

## Single-Server Scenario (Training)

In the single-server training scenario, the supported products and OSs are shown in the following table.

**Table 1**  Supported products and OSs
...
<tbody><tr id="row193141923124213"><td class="cellrowborder" rowspan="5" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p13314132394215"><a name="p13314132394215"></a><a name="p13314132394215"></a><span id="ph1331492318423"><a name="ph1331492318423"></a><a name="ph1331492318423"></a>Atlas Training Series Products</span></p>
</td>
...
<tr id="row5314823154211"><td class="cellrowborder" rowspan="4" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p73141323184218"><a name="p73141323184218"></a><a name="p73141323184218"></a><span id="ph2314323124211"><a name="ph2314323124211"></a><a name="ph2314323124211"></a><term id="zh-cn_topic_0000001519959665_term57208119917"><a name="zh-cn_topic_0000001519959665_term57208119917"></a><a name="zh-cn_topic_0000001519959665_term57208119917"></a>Atlas A2 Training Series Products</term></span></p>
...
<tr id="row13314162394218"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p14314142374220"><a name="p14314142374220"></a><a name="p14314142374220"></a><span id="ph1431418234423"><a name="ph1431418234423"></a><a name="ph1431418234423"></a>Atlas 900 A2 PoDc Cluster Base Unit</span></p>
</td>
...
<tr id="row153141923154210"><td class="cellrowborder" rowspan="2" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p931415234425"><a name="p931415234425"></a><a name="p931415234425"></a><span id="ph531432344210"><a name="ph531432344210"></a><a name="ph531432344210"></a><term id="zh-cn_topic_0000001519959665_term26764913715"><a name="zh-cn_topic_0000001519959665_term26764913715"></a><a name="zh-cn_topic_0000001519959665_term26764913715"></a>Atlas A3 Training Series Products</term></span></p>
...
<tr id="row73155239422"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p1231542318428"><a name="p1231542318428"></a><a name="p1231542318428"></a><span id="ph1031518232426"><a name="ph1031518232426"></a><a name="ph1031518232426"></a>Atlas 800T A3 SuperPoD</span></p>
</td>
...
<tr id="row16507172322215"><td class="cellrowborder" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p3927183818221"><a name="p3927183818221"></a><a name="p3927183818221"></a><span id="ph1692713816224"><a name="ph1692713816224"></a><a name="ph1692713816224"></a>A200T A3 Box8 SuperPoD</span></p>
</td>
<td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.2 "><p id="p166420278225"><a name="p166420278225"></a><a name="p166420278225"></a><span id="ph064214271224"><a name="ph064214271224"></a><a name="ph064214271224"></a>A200T A3 Box8 SuperPoD</span></p>
</td>
...
<tr id="row7316192354212"><td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.4.1.1 mcps1.2.4.1.2 mcps1.2.4.1.3 "><p id="p331612304218"><a name="p331612304218"></a><a name="p331612304218"></a>Note:</p>
<p id="p1431613237421"><a name="p1431613237421"></a><a name="p1431613237421"></a>For version 6.0.RC2 and later, resource monitoring, full-NPU scheduling, and resumable training features of <span id="ph183161923104214"><a name="ph183161923104214"></a><a name="ph183161923104214"></a>Ascend Operator</span> are supported by the <span id="ph831682314426"><a name="ph831682314426"></a><a name="ph831682314426"></a>Atlas 900 A3 SuperPoD</span>.</p>
</td>
</tr>
</tbody>
</table>

## Single-Server Scenario (Inference)

In the single-server inference scenario, the supported products and OSs are shown in the following table.

**Table 2** Supported products and OSs
...
<tbody><tr id="row87471045632"><td class="cellrowborder" rowspan="9" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p174718453315"><a name="p174718453315"></a><a name="p174718453315"></a><span id="ph19590185162111"><a name="ph19590185162111"></a><a name="ph19590185162111"></a>Atlas Inference Series Products</span></p>
...
<tr id="row177472451314"><td class="cellrowborder" valign="top" headers="mcps1.2.4.1.1 "><p id="p135998206190"><a name="p135998206190"></a><a name="p135998206190"></a><span id="ph14285172325711"><a name="ph14285172325711"></a><a name="ph14285172325711"></a>Atlas 800 Inference Server (Model 3000)</span> (with <span id="ph12599520201912"><a name="ph12599520201912"></a><a name="ph12599520201912"></a>Atlas 300V Video Analysis Card</span>)</p>
</td>
...
<tr id="row12748144512318"><td class="cellrowborder" rowspan="3" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p19470381257"><a name="p19470381257"></a><a name="p19470381257"></a><span id="ph996833614580"><a name="ph996833614580"></a><a name="ph996833614580"></a><term id="zh-cn_topic_0000001094307702_term99602034117"><a name="zh-cn_topic_0000001094307702_term99602034117"></a><a name="zh-cn_topic_0000001094307702_term99602034117"></a>Atlas A2 Inference Series Products</term></span></p>
...
<tr id="row15438111011218"><td class="cellrowborder" valign="top" width="15.93%" headers="mcps1.2.4.1.1 "><p id="p168412537204"><a name="p168412537204"></a><a name="p168412537204"></a><span id="ph791742714211"><a name="ph791742714211"></a><a name="ph791742714211"></a><term id="zh-cn_topic_0000001519959665_term176419491615"><a name="zh-cn_topic_0000001519959665_term176419491615"></a><a name="zh-cn_topic_0000001519959665_term176419491615"></a>Atlas A3 Inference Series Products</term></span></p>
</td>
<td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.2 "><p id="p143871017213"><a name="p143871017213"></a><a name="p143871017213"></a><span id="ph18760103420211"><a name="ph18760103420211"></a><a name="ph18760103420211"></a>Atlas 800I A3 SuperPoD</span></p>
</td>
...
<tr id="row64419316256"><td class="cellrowborder" colspan="3" valign="top" headers="mcps1.2.4.1.1 mcps1.2.4.1.2 mcps1.2.4.1.3 "><a name="ul17949191917256"></a><a name="ul17949191917256"></a><ul id="ul17949191917256"><li><strong id="b189491819122517"><a name="b189491819122517"></a><a name="b189491819122517"></a>In a standalone scenario: The following hardware products only support the installation of the <span id="ph10949131918259"><a name="ph10949131918259"></a><a name="ph10949131918259"></a>Ascend Docker Runtime</span> component.</strong></li><li><strong id="b094919197251"><a name="b094919197251"></a><a name="b094919197251"></a>In a cluster scenario: The following hardware products only support the installation of the <span id="ph1294912191256"><a name="ph1294912191256"></a><a name="ph1294912191256"></a>Ascend Docker Runtime</span> and <span id="ph1794971919254"><a name="ph1794971919254"></a><a name="ph1794971919254"></a>Ascend Device Plugin</span> components.</strong></li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.67%" headers="mcps1.2.4.1.2 "><p id="p18478175248"><a name="p18478175248"></a><a name="p18478175248"></a><span id="ph847101717244"><a name="ph847101717244"></a><a name="ph847101717244"></a>Atlas 200 AI Acceleration Module (RC Scenario)</span></p>
</td>
<td class="cellrowborder" rowspan="7" valign="top" width="50.4%" headers="mcps1.2.4.1.3 "><p id="p16081439161317"><a name="p16081439161317"></a><a name="p16081439161317"></a>The supported OSs are subject to the hardware product itself.</p>
</td>
</tr>
