...
## rings-config-<job_name\><a name="section1377115581385"></a>

**Table 1** rings-config-<job_name\>

<a name="table1328211233126"></a>
<table><thead align="left"><tr id="row2028442312126"><th class="cellrowborder" valign="top" width="9.99%" id="mcps1.2.6.1.1"><p id="p0566161515246"><a name="p0566161515246"></a><a name="p0566161515246"></a>Field Name</p>
</th>
<th class="cellrowborder" valign="top" width="20.630000000000003%" id="mcps1.2.6.1.2"><p id="p428442317128"><a name="p428442317128"></a><a name="p428442317128"></a>Name</p>
</th>
<th class="cellrowborder" valign="top" width="27.779999999999998%" id="mcps1.2.6.1.3"><p id="p32851623121215"><a name="p32851623121215"></a><a name="p32851623121215"></a>Function</p>
</th>
<th class="cellrowborder" valign="top" width="18.48%" id="mcps1.2.6.1.4"><p id="p122851233123"><a name="p122851233123"></a><a name="p122851233123"></a>Value</p>
</th>
<th class="cellrowborder" valign="top" width="23.119999999999997%" id="mcps1.2.6.1.5"><p id="p2028522371219"><a name="p2028522371219"></a><a name="p2028522371219"></a>Remarks</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="27.779999999999998%" headers="mcps1.2.6.1.3 "><p id="p628512301218"><a name="p628512301218"></a><a name="p628512301218"></a>Format version used by the RankTable</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p528602331212"><a name="p528602331212"></a><a name="p528602331212"></a>Number of nodes used by a job</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p10286623111214"><a name="p10286623111214"></a><a name="p10286623111214"></a>Integer</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p12287423101219"><a name="p12287423101219"></a><a name="p12287423101219"></a>Node information used by a job</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p228820231122"><a name="p228820231122"></a><a name="p228820231122"></a>AI Server identifier, globally unique</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p928812351211"><a name="p928812351211"></a><a name="p928812351211"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p17314111571"><a name="p17314111571"></a><a name="p17314111571"></a>Host IP address of the AI Server</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p731131111573"><a name="p731131111573"></a><a name="p731131111573"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p128916238124"><a name="p128916238124"></a><a name="p128916238124"></a>Chip information used by a job</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p5289423131210"><a name="p5289423131210"></a><a name="p5289423131210"></a>Physical ID of the chip used by a job</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p0289172316122"><a name="p0289172316122"></a><a name="p0289172316122"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p14290023151213"><a name="p14290023151213"></a><a name="p14290023151213"></a>IP address of the chip used by a job</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p1929042321217"><a name="p1929042321217"></a><a name="p1929042321217"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.2 "><p id="p12291202391210"><a name="p12291202391210"></a><a name="p12291202391210"></a>Rank ID of the chip used by a job</p>
</td>
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.3 "><p id="p17291223121215"><a name="p17291223121215"></a><a name="p17291223121215"></a>String</p>
</td>
...
<td class="cellrowborder" valign="top" width="27.779999999999998%" headers="mcps1.2.6.1.3 "><p id="p165492487247"><a name="p165492487247"></a><a name="p165492487247"></a>Version of hccl.json used by a job</p>
</td>
<td class="cellrowborder" valign="top" width="18.48%" headers="mcps1.2.6.1.4 "><p id="p145492048112416"><a name="p145492048112416"></a><a name="p145492048112416"></a>String</p>
</td>
...
Ascend Operator starts an HTTP health probe service within the component, which is used by the K8s livenessProbe mechanism to detect the component's liveness status.
...
For detailed probe parameter descriptions, see [Parameter Description](../05_developer_guide/00_installation_deployment/00_manual_installation/08_ascend_operator.md#parameter-description).
