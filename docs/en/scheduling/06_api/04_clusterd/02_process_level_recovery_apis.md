...
**Data Description<a name="section10140143475520"></a>**

|Parameter|Type (Protobuf Definition)|Description|
|--|--|--|
|ProcessManageSignal|<p>message FaultRank{<p>string rankId = 1;</p><p>string faultType = 2;</p>}</p><p>message ProcessManageSignal{<p>string uuid=1;</p><p>string jobId = 2;</p><p>string signalType = 3;</p><p>repeated string actions = 4;</p><p>repeated FaultRank faultRanks = 5;</p><p>string changeStrategy = 6;</p><p>int64 timeout = 7;</p><p>repeated string nodeRankIds = 8;</p><p>string extraParams = 9;</p>}</p>|<p>**rankId**: string type, ID of the faulty card.<br>**faultType**: string type, type of the fault.<br>**uuid**: string type, UUID of this signal.<br>**jobId**: string type, ID of the training job.<br>**signalType**: string type, type of the signal.<br>**actions**: repeated string, actions to be performed.<br>**faultRanks**: repeated FaultRank, information about the faulty cards.<br>**changeStrategy**: string type, recovery strategy to be executed.<br>**timeout**: int64 type, timeout duration.<br>**nodeRankIds**: repeated string, Node Rank IDs of the faulty nodes.<br>**extraParams**: string type, specific scaling strategy information passed in JSON string format, which is passed through TaskD to MindIO and eventually to the callback function for parsing.</p>|
