...
>[!NOTE]
>Resilience Controller has been deprecated as of version 7.3.0. The content in this chapter is for reference only. To use it, please obtain a software package from a version prior to 7.3.0.
...
<th class="cellrowborder" valign="top" width="19.24807519248075%" id="mcps1.2.5.1.2"><p id="p14528105765013"><a name="p14528105765013"></a><a name="p14528105765013"></a> Certificate and Configuration File Path</p>
</th>
...
<tbody><tr id="row9528155785012"><td class="cellrowborder" valign="top" width="17.5982401759824%" headers="mcps1.2.5.1.1 "><p id="p1528155715501"><a name="p1528155715501"></a><a name="p1528155715501"></a><span id="ph1488142812262"><a name="ph1488142812262"></a><a name="ph1488142812262"></a>Cluster scheduling component</span> certificate root directory</p>
</td>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.5.1.4 "><p id="p176150132191"><a name="p176150132191"></a><a name="p176150132191"></a>.config/config6: Imported encrypted<span id="ph10615131313194"><a name="ph10615131313194"></a><a name="ph10615131313194"></a> K8s</span> KubeConfig file, used for connecting to <span id="ph761518136190"><a name="ph761518136190"></a><a name="ph761518136190"></a>K8s</span>.</p>
...
- To use elastic training, Resilience Controller must be installed. When Resilience Controller connects to K8s, you can choose to authenticate using a ServiceAccount or a KubeConfig file. For differences between the two methods, see [Differences Between ServiceAccount and KubeConfig](../../../07_references/05_appendix.md).
...
The command output is as follows. **Running** indicates that the component startup is successful.
...
<td class="cellrowborder" valign="top" width="15%" headers="mcps1.2.5.1.2 "><p id="p123213019227"><a name="p123213019227"></a><a name="p123213019227"></a>N/A</p>
</td>
<td class="cellrowborder" valign="top" width="15%" headers="mcps1.2.5.1.3 "><p id="p1832100102210"><a name="p1832100102210"></a><a name="p1832100102210"></a>N/A</p>
</td>
