...
- Users who only use containerization support and resource monitoring do not need to install Volcano. Please skip this chapter directly.
    ...
    >[!NOTE]
    >- In this document, Volcano refers to Volcano included in the cluster scheduler components by default. Other schedulers based on open-source Volcano can integrate the Ascend-volcano-plugin for developers to implement NPU scheduling-related functions. For details, see  [(Optional) Integrating Ascend Plugins to Extend Open-Source Volcano](#optional-integrating-ascend-plugins-to-extend-open-source-volcano).
    ...
    data:
      volcano-scheduler.conf: |
        ...
        - plugins:
          ...
          - name: conformance
            enableNodeOrder: false
          - name: volcano-npu_v26.1.0_linux-aarch64   # v26.1.0 is MindCluster version number, which varies according to the actual version in use.
        - plugins:
          - name: drf
            enableNodeOrder: false
          - name: predicates
...
7. (Optional) In `volcano-v{version}.yaml`, enable the Volcano health check interface and the Prometheus information collection interface.
    ...
    ...
            - name: volcano-scheduler
              image: volcanosh/vc-scheduler:v1.7.0-v26.1.0   # Starting from MindCluster v26.1.0, the tag must include the corresponding version number
              args: [ ...
                  ...
    ...
    **Table 2** Description of open interfaces of Volcano
    ...
    <td class="cellrowborder" valign="top" width="16.89168916891689%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0000001446965056_p193087624718"><a name="zh-cn_topic_0000001446965056_p193087624718"></a><a name="zh-cn_topic_0000001446965056_p193087624718"></a>Prometheus metrics collection port</p>
    </td>
...
8. (Optional) In `volcano-v{version}.yaml`, configure the mode for deleting Pods during rescheduling, virtualization mode, switch affinity scheduling, and whether to self-maintain available chip status.
    ...
    ...
        configurations:
          - name: init-params
            arguments: {<strong>"grace-over-time":"900","presetVirtualDevice":"true","nslb-version":"1.0","shared-tor-num":"2","useClusterInfoManager":"false","self-maintain-available-card":"true","super-pod-size": "48","reserve-nodes": "2","forceEnqueue":"true","prefer-previous-node":"true"</strong>}
    ...</pre>

    **Table 3**  Parameter description

    <a name="table208981646194315"></a>
    <table><thead align="left"><tr id="row08991746174316"><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.4.1.1"><p id="p132621494445"><a name="p132621494445"></a><a name="p132621494445"></a>Parameter</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="60%" id="mcps1.2.4.1.3"><p id="p18991846144317"><a name="p18991846144317"></a><a name="p18991846144317"></a>Description</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p145262285146"><a name="p145262285146"></a><a name="p145262285146"></a>The maximum time allowed for deleting a Pod in graceful deletion mode during rescheduling, in seconds, with a value range of 2 to 3600. Configuring this field enables the graceful deletion mode for rescheduling. Graceful deletion means that during rescheduling, the system waits for Volcano to perform related cleanup work. If the Pod has not been successfully deleted after 900 seconds, it will be forcibly deleted directly without cleanup.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p135221235105419"><a name="p135221235105419"></a><a name="p135221235105419"></a>The virtualization mode to use.</p>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p7830165414514"><a name="p7830165414514"></a><a name="p7830165414514"></a>The version of switch affinity scheduling. Valid values are 1.0 and 2.0.</p>
    <div class="note" id="note882315541054"><a name="note882315541054"></a><a name="note882315541054"></a><span class="notetitle">Note</span><div class="notebody"><a name="ul59831535122714"></a><a name="ul59831535122714"></a><ul id="ul59831535122714"><li>Switch affinity scheduling v1.0 supports <span id="ph1157665817140"><a name="ph1157665817140"></a><a name="ph1157665817140"></a><term>Atlas training products</term></span> and <span id="ph168598363399"><a name="ph168598363399"></a><a name="ph168598363399"></a><term id="zh-cn_topic_0000001519959665_term57208119917"><a name="zh-cn_topic_0000001519959665_term57208119917"></a><a name="zh-cn_topic_0000001519959665_term57208119917"></a>Atlas A2 training products</term></span>; supports <span id="ph4181625925"><a name="ph4181625925"></a><a name="ph4181625925"></a>PyTorch</span> and <span id="ph61882510210"><a name="ph61882510210"></a><a name="ph61882510210"></a>MindSpore</span>.</li><li>>Switch affinity scheduling v2.0 supports <span id="ph311717506401"><a name="ph311717506401"></a><a name="ph311717506401"></a><term id="zh-cn_topic_0000001519959665_term57208119917_1"><a name="zh-cn_topic_0000001519959665_term57208119917_1"></a><a name="zh-cn_topic_0000001519959665_term57208119917_1"></a>Atlas A2 training products</term></span>; supports<span id="ph619244413568"><a name="ph619244413568"></a><a name="ph619244413568"></a>PyTorch</span>.</li></ul>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p925113215214"><a name="p925113215214"></a><a name="p925113215214"></a>The maximum number of shared switches that can be used by a single job in switch affinity scheduling v2.0. Valid values are 1 or 2. This parameter only takes effect when `nslb-version` is set to 2.0.</p>
    <p id="p1856962434719"><a name="p1856962434719"></a><a name="p1856962434719"></a>For more information on switch affinity scheduling (v1.0 or v2.0), refer to the <a href="../../../04_usage/03_basic_scheduling/01_affinity_scheduling/04_node_based_affinity.md">Node-Based Affinity</a>.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p1797510751015"><a name="p1797510751015"></a><a name="p1797510751015"></a><span id="ph18393155819297"><a name="ph18393155819297"></a><a name="ph18393155819297"></a></span>The method by which Volcano obtains cluster information. Valid values are as follows:</p>
    <a name="ul675021361014"></a><a name="ul675021361014"></a><ul id="ul675021361014"><li>true: Read<span id="ph16899408574"><a name="ph16899408574"></a><a name="ph16899408574"></a>the ConfigMap</span> reported by<span id="ph1921415457302"><a name="ph1921415457302"></a><a name="ph1921415457302"></a>ClusterD</span>.</li><li>false: Read the ConfigMaps reported<span id="ph19274234236"><a name="ph19274234236"></a><a name="ph19274234236"></a>Ascend Device Plugin</span> and <span id="ph144095321390"><a name="ph144095321390"></a><a name="ph144095321390"></a>NodeD</span>.<span id="ph039324431114"><a name="ph039324431114"></a><a name="ph039324431114"></a></span></li></ul>
    <div class="note" id="note1466414341216"><a name="note1466414341216"></a><a name="note1466414341216"></a><span class="notetitle">Note</span><div class="notebody"><p id="p1166463181214"><a name="p1166463181214"></a><a name="p1166463181214"></a>By default, <span id="ph19101421151220"><a name="ph19101421151220"></a><a name="ph19101421151220"></a>the ConfigMap reported </span>by ClusterD<span id="ph139579361121"><a name="ph139579361121"></a><a name="ph139579361121"></a> is used</span>. Future versions will no longer support <span id="ph3588183951516"><a name="ph3588183951516"></a><a name="ph3588183951516"></a>reading the ConfigMaps</span><span id="ph1758893981514"><a name="ph1758893981514"></a><a name="ph1758893981514"></a> reported by</span> Ascend Device Plugin<span id="ph75887392157"><a name="ph75887392157"></a><a name="ph75887392157"></a> and NodeD.</span></p>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p151414164516"><a name="p151414164516"></a><a name="p151414164516"></a>Whether Volcano self-maintains the available chip status. Valid values are as follows:</p>
    <a name="ul299044019472"></a><a name="ul299044019472"></a><ul id="ul299044019472"><li>true: Volcano self-maintains the available chip status.</li><li>false: Volcano obtains the available chip status<span id="ph98552414486"><a name="ph98552414486"></a><a name="ph98552414486"></a> from the ConfigMap reported</span> by ClusterD<span id="ph1185824104819"><a name="ph1185824104819"></a><a name="ph1185824104819"></a> or </span>Ascend Device Plugin.</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p461323812519"><a name="p461323812519"></a><a name="p461323812519"></a><span id="ph128111331314"><a name="ph128111331314"></a><a name="ph128111331314"></a>The number of nodes with an </span>Atlas 900 A3 SuperPoD.</p>
    <p id="p1704246153099"><a name="p1704246153099"></a><a name="p1704246153099"></a>Value range: greater than 0. If set to 0, a negative number, or a non-numeric value, it is treated as a configuration error and the default value of 48 is used.</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p25637568515"><a name="p25637568515"></a><a name="p25637568515"></a><span id="ph915032251212"><a name="ph915032251212"></a><a name="ph915032251212"></a>The number of reserved nodes</span> within an Atlas 900 A3 SuperPoD.</p>
    <p id="p1704246153100"><a name="p1704246153100"></a><a name="p1704246153100"></a>Value range: greater than or equal to `0`. When set to `0`, no nodes are reserved.</p>
    <div class="note" id="note1514175285210"><a name="note1514175285210"></a><a name="note1514175285210"></a><span class="notetitle">Note</span><div class="notebody"><p id="p96481321115510"><a name="p96481321115510"></a><a name="p96481321115510"></a>If reserve-nodes is greater than super-pod-size, the following applies:</p>
    <a name="ul13842528165510"></a><a name="ul13842528165510"></a><ul id="ul13842528165510"><li>If super-pod-size is greater than 2, reserve-nodes is reset to the default value of 2.</li><li>If super-pod-size is less than or equal to 2, reserve-nodes is reset to 0.</li></ul>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p1790852711505"><a name="p1790852711505"></a><a name="p1790852711505"></a><span id="ph188121729115116"><a name="ph188121729115116"></a><a name="ph188121729115116"></a>Whether a job is forced into the pending scheduling queue</span><span id="ph280124455118"><a name="ph280124455118"></a><a name="ph280124455118"></a> when cluster NPU resources are sufficient.</span><span id="ph1179814511514"><a name="ph1179814511514"></a><a name="ph1179814511514"></a></span><span id="ph2278145215114"><a name="ph2278145215114"></a><a name="ph2278145215114"></a> Valid values are as follows:</span></p>
    <a name="ul12820554135117"></a><a name="ul12820554135117"></a><ul id="ul12820554135117"><li>true: When Volcano enables the Enqueue action<span id="ph11766123385220"><a name="ph11766123385220"></a><a name="ph11766123385220"></a></span>, if the cluster NPU resources meet the current job's requirements, the job<span id="ph3349644125319"><a name="ph3349644125319"></a><a name="ph3349644125319"></a> is forced into </span><span id="ph22191237135316"><a name="ph22191237135316"></a><a name="ph22191237135316"></a> the pending scheduling queue</span>, regardless of whether other resources are sufficient. If the current job remains in the pending queue for an extended period, it may pre-occupy resources, potentially preventing other jobs from being enqueued.</li><li>Other values: When cluster NPU resources are insufficient, <span id="ph6205121155415"><a name="ph6205121155415"></a><a name="ph6205121155415"></a>the job is rejected from entering the pending scheduling queue.</span>If NPU resources meet the current job's requirements,<span id="ph370210413554"><a name="ph370210413554"></a><a name="ph370210413554"></a> all plugins collectively decide whether to allow the job to enter the pending scheduling queue.</span></li></ul>
    <p id="p12691948115614"><a name="p12691948115614"></a><a name="p12691948115614"></a>For detailed information about this parameter, refer to <a href="https://volcano.sh/docs/v1.9.0/Scheduler/Actions" target="_blank" rel="noopener noreferrer">Volcano Actions</a>.</p>
    </td>
    </tr>
    <tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>resource-level-config</p>
    </td>
    <td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p>Empty by default</p>
    </td>
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>A JSON configuration of network resource levels corresponding to nodes in the cluster.</p><p>This parameter is only used in multi-level scheduling jobs and does not need to be configured for non-multi-level scheduling jobs.</p><p>Valid values are as follows:</p><ul><li>The first-level key in the JSON file is the name of the network topology tree, and the corresponding value is the detailed definition of that network topology tree.</li><li>In the detailed definition of the network topology tree, keys identify specific network levels, with the format `level` + the network level number `n` (where `n` is a positive integer ≥ 1). The value is the corresponding network level definition structure.</li><li>In the network level definition structure, the following fields exist:<ul><li>label: Identifies the key of the node label for that network level. The value is a string.</li><li>reservedNode: Identifies the number of reserved nodes at the sub-level. The value is an integer. This only takes effect in the level1 configuration. During multi-level scheduling, the scheduler first attempts to deduct the reserved number of nodes for scheduling. If scheduling with the reserved nodes deducted fails, the reserved node resources are then used normally.</li></ul></li></ul><p>>For detailed information and examples of this parameter, refer to<a href="../../../04_usage/03_basic_scheduling/04_multi_level_scheduling.md#configuring-volcano-startup-parameters"> Configuring Volcano Startup Parameters</a>.</p>
    </td>
    </tr>
    <tr id="row_prefer_previous_node"><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p id="p_prefer_previous_node_name"><a name="p_prefer_previous_node_name"></a><a name="p_prefer_previous_node_name"></a>prefer-previous-node</p>
    </td>
    <td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p id="p_prefer_previous_node_default"><a name="p_prefer_previous_node_default"></a><a name="p_prefer_previous_node_default"></a>true</p>
    </td>
    <td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p id="p_prefer_previous_node_desc"><a name="p_prefer_previous_node_desc"></a><a name="p_prefer_previous_node_desc"></a>Whether to enable the feature that prioritizes scheduling Pods back to their original node after reconstruction. Valid values are as follows:</p>
    <a name="ul_prefer_previous_node"></a><a name="ul_prefer_previous_node"></a><ul id="ul_prefer_previous_node"><li>true (default): Enabled. When a Pod is evicted, rescheduled due to a fault, or re-scaled after scale-in, it is preferentially scheduled back to the node where it previously ran. This reuses the existing container image cache (15–40 GB) on the node, reducing startup time from 5–20 minutes to seconds.</li><li>false: Disabled.</li></ul>
    <p id="p_prefer_previous_node_scenarios"><a name="p_prefer_previous_node_scenarios"></a><a name="p_prefer_previous_node_scenarios"></a>The effect of this parameter on different job types is as follows:</p>
    <p id="p_prefer_previous_node_normal"><a name="p_prefer_previous_node_normal"></a><a name="p_prefer_previous_node_normal"></a><b>Normal scheduling scenario:</b></p>
    <a name="ul_prefer_previous_node_normal"></a><a name="ul_prefer_previous_node_normal"></a><ul id="ul_prefer_previous_node_normal"><li>When a Pod is reconstructed, it is preferentially scheduled back to its original node to reuse the existing container image cache and avoid re-pulling the image.</li><li>Healthy Pods have the highest priority to return to their original node; faulty Pods actively avoid the original node and choose other nodes to move out of the fault domain.</li></ul>
    <p id="p_prefer_previous_node_affinity"><a name="p_prefer_previous_node_affinity"></a><a name="p_prefer_previous_node_affinity"></a><b>Inter-node affinity scheduling scenarios (SuperPoD scheduling / multi-level scheduling / rack affinity scheduling):</b></p>
    <a name="ul_prefer_previous_node_affinity"></a><a name="ul_prefer_previous_node_affinity"></a><ul id="ul_prefer_previous_node_affinity"><li>In non-fault rescheduling scenarios (e.g., rescheduling after eviction), if all nodes from the previous run are still available, each Pod is scheduled back to its original node to continue running.</li><li>In fault rescheduling scenarios, the scheduler performs node replacement according to the original scheduling logic. For detailed rescheduling strategies for each scheduling policy, refer to <a href="../../../04_usage/03_basic_scheduling/01_affinity_scheduling/04_node_based_affinity.md">Node-Based Affinity</a>.</li></ul>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    >- K8s supports node affinity scheduling using the nodeAffinity field. For a detailed description of this field, see the [Kubernetes official documentation](https://kubernetes.io/docs/tasks/configure-pod-container/assign-pods-nodes-using-node-affinity/). Volcano also supports this field. For operation instructions, see the [Scheduling Configuration](../../../07_references/02_common_operations.md#scheduling-configuration) chapter.
...
<div class="note" id="note19596191219291"><a name="note19596191219291"></a><a name="note19596191219291"></a><div class="notebody"><p id="p10596012112919"><a name="p10596012112919"></a><a name="p10596012112919"></a>The naming format for dumped files is: volcano-scheduler.log-<i>{rotation_time}</i>.gz, for example: volcano-scheduler.log-20230926.gz.</p>
</div></div>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="30%" headers="mcps1.2.5.1.4 "><p id="p11530165644617"><a name="p11530165644617"></a><a name="p11530165644617"></a>Percentage of available nodes to select from the total cluster nodes during job scheduling.</p>
</td>
</tr>
</tbody>
</table>
...
<div class="note" id="note215144410296"><a name="note215144410296"></a><a name="note215144410296"></a><div class="notebody"><p id="p715144132910"><a name="p715144132910"></a><a name="p715144132910"></a>The naming format for files after dumping is: volcano-controller.log-<i>{rotation_time}</i>.gz, for example: volcano-controller.log-20230926.gz.</p>
</div></div>
</td>
</tr>
...
>[!NOTE]
>Currently, only full-NPU switch affinity scheduling is supported for training and inference jobs. Static or dynamic vNPU scheduling is not supported.
...
4. Choose one of the following two methods to start the volcano-scheduler component.
    - Using the startup YAML of the MindCluster Volcano
        1. Run the following command to build the Volcano image. Select the corresponding parameter for the image based on the open-source code version, such as v1.7.0.
            ...
            ```shell
            # Starting from MindCluster v26.1.0, the tag must include the corresponding version number.
            ...
            data:
               volcano-scheduler.conf: |
                 ...
                 - plugins:
                   ...
                   - name: conformance
                   <strong>- name: volcano-npu_v26.1.0_linux-x86_64    # Custom scheduling plugin added in ConfigMap. Ensure version compatibility between components.</strong>
                 - plugins:
                   - name: overcommit
                   - name: drf
                     enablePreemptable: false
