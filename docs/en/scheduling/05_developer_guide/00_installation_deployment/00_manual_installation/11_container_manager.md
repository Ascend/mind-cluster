...
> [!NOTE]
> Container Manager is only applicable to scenarios without K8s. In K8s scenarios, fault detection and recovery capabilities are provided collaboratively by components such as ClusterD, Ascend Device Plugin, and Volcano, and Container Manager does not need to be installed.
...
## Supported Product Forms<a name="section_supported_products"></a>

- The following products support fault management and automatic container recovery for fault containers:
...
<div class="note" id="note_deploy_upgrade"><a name="note_deploy_upgrade"></a><a name="note_deploy_upgrade"></a><span class="notetitle">Note</span><div class="notebody"><a name="ul_deploy_upgrade_note"></a><a name="ul_deploy_upgrade_note"></a><ul id="ul_deploy_upgrade_note"><li>Use the upgrade command for upgrades. Using the install command multiple times will overwrite existing service configurations (such as startup parameters), which may cause service configuration loss.</li></ul>
</div></div>
</td>
</tr>
</tbody>
...
<td class="cellrowborder" valign="top" headers="mcps1.2.6.1.4 "><p id="p16458189133819"><a name="p16458189133819"></a><a name="p16458189133819"></a>Custom fault configuration file path. If not configured, the default fault code configuration is used. For details about custom fault configuration files, see <a href="../../../04_usage/05_appliance/01_npu_hardware_fault_detection_and_rectification.md#fault-level-configuration">Fault Level Configuration</a>.</p>
