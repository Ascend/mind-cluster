...
#### MMindSpore Adaptation Example (Based on MindFormers)<a name="ZH-CN_TOPIC_0000002511346369"></a>

1. Set up the training environment and start training. For details, see [MMindSpore Adaptation Example (Based on MindFormers)](./usage/resumable_training/07_using_resumable_training_on_the_cli.md#adaptation-example).
2. Enable online process-level recovery. For details, see [Configuring Process-Level Online Recovery](./usage/resumable_training/04_configuring_fault_handling_policies.md#configuring-process-level-online-recovery).
