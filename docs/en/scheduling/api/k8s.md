...
|<p>huawei.com/Ascend910</p><p>huawei.com/npu</p>|Basis for Ascend Device Plugin to allocate chips to Pods. The specific value corresponds to davinciX under /dev/. For the Ascend950 generation, it is the NPU ID; for previous generations, it is the physical ID.|String|Volcano, Ascend Device Plugin|
