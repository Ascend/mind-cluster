...
The fields in the custom metric file are shown in [Table 1](#ZH-CN_TOPIC_0000002501343480_table5395205714441). Custom metrics can be developed via a custom metric file. For details, see [Custom Metric Development](../../references/appendix.md).
