...
|(Optional) Mask error logs of CANN App logs.|[(Optional) Masking Fault Logs](./05_masking_fault_logs.md)|For details about the API, see [Fault Log Masking](../api/fault_log_masking.md). |
