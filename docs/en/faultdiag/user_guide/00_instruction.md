...
|--|--|--|--|
|CANN App logs|CANN|7.0.RC1 or later|Host App logs and device App logs printed by CANN. For more information, see [Viewing Logs (Ascend EP)](<https://www.hiascend.com/document/detail/en/CANNCommunityEdition/900/maintenref/logreference/logreference_0002.html>) in the *CANN Log Reference*.|
...
|AMCT logs|Model compression toolkit|7.0.RC1 or later|AMCT is integrated into the CANN package for release. For more information, see [AMCT User Guide](<https://www.hiascend.com/document/detail/en/CANNCommunityEdition/900/devaids/amct/atlasamct_16_0001.html>).|
