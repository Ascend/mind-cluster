...
// testWithoutRoCEDevAscend310 tests Ascend310 card type
func testWithoutRoCEDevAscend310(t *testing.T) {
...
// testWithoutRoCEDevAscend310P tests Ascend310P card type
func testWithoutRoCEDevAscend310P(t *testing.T) {
...
// testWithoutRoCEDevAscend310B tests Ascend310B card type
func testWithoutRoCEDevAscend310B(t *testing.T) {
...
// testWithoutRoCEDevAscend910 tests Ascend910 card type
func testWithoutRoCEDevAscend910(t *testing.T) {
...
// testWithoutRoCEDevAscend910A3 tests Ascend910A3 card type
func testWithoutRoCEDevAscend910A3(t *testing.T) {
...
// testWithoutRoCEDevEmpty tests empty card type
func testWithoutRoCEDevEmpty(t *testing.T) {
...
// testWithoutRoCEDevUnknown tests unknown card type
func testWithoutRoCEDevUnknown(t *testing.T) {
