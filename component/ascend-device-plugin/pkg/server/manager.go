...
func (hdm *HwDevManager) loadUpgradeReasonFromCm() {
	cache, err := hdm.manager.LoadUpgradeFaultReasonMapFromDeviceInfoCm()
	if err != nil {
		hwlog.RunLog.Errorf("loadUpgradeReasonFromCm error: %v", err)
		return
	}
