...
func (hnm *HwAscend310PManager) GraceTolerance(context.Context, map[string][]*common.NpuDevice) {
	return
}
...
func (hnm *HwAscend310PManager) SetDpu(string, []common.DpuCMData, map[string][]string) {
	return
}
