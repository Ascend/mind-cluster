...
/*
Package serviceapi provides API
*/
package serviceapi
...
import (
	...
	"ascend-faultdiag-online/pkg/service/serviceapi/eventapi"
	"ascend-faultdiag-online/pkg/service/serviceapi/metricapi"
	"ascend-faultdiag-online/pkg/utils/constants"
)

type ApiFunc func(fdCtx *context.FaultDiagContext, reqCtx *request.Context) error
...
func BuildApiFunc(param *ApiFuncBuildParam) (ApiFunc, error) {
	...
	return func(fdCtx *context.FaultDiagContext, reqCtx *request.Context) error {
		err := json.Unmarshal([]byte(reqCtx.ReqJson), param.ReqModel)
		if err != nil {
			return err
		}
		args = append(args, reflect.ValueOf(fdCtx))
