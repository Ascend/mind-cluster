...
GENERATION_INFO_A5 = "V950"
DEFAULT_GENERATION_SIGN = "A2/A3"
GENERATION_SIGN_A5 = "A5"
EID_PLANE_INFO = "Net2PeerLink"
RANK_ID_INFO = "rankId["
EID_ID_INFO = "eid["
PLANE_ID_INFO = "planeId["
# socket timeout info
...
ERROR_CQE_A5 = "cqe error status[5]"
ERROR_CQE_LATEST = "remoteIP{"
ERROR_CQE_SPLIT = "ip:["
ERROR_CQE_NEW_SPLIT = "remoteIP:["
ERROR_CQE_A5_SPLIT = "remoteEid[eid["
ERROR_CQE_LATEST_SPLIT = "deviceIp["
...
TIMEOUT_KEYWORD_A5 = "Env config"
HCCL_ENV_KEYWORD_A5 = "HCCL_ENV"
CONNECT_TIMEOUT_KEYWORD_A5 = "linkTimeOut["
EXEC_TIMEOUT_KEYWORD_A5 = "execTimeOut["
RDMA_TIMEOUT_KEYWORD_A5 = "rdmaTimeOut["
RDMA_RETRY_CNT_KEYWORD_A5 = "rdmaRetryCnt["
...
DETECT_RANKTABLE_IMPL = "DetectRankTableImpl"
NRANKS_INFO = "nRanks["
...
# RFC-compliant IPv6 address pattern (supports full, compressed, IPv4-mapped formats)
IPV6_ADDR_PATTERN = (
    ...
    r"|(?:[0-9A-Fa-f]{1,4}):(?:(?::[0-9A-Fa-f]{1,4}){1,6}|(?::[0-9A-Fa-f]{1,4}){0,4}:(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(?:\.(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:)"
    r"|:(?:(?::[0-9A-Fa-f]{1,4}){1,7}|(?::[0-9A-Fa-f]{1,4}){0,5}:(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(?:\.(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:)"
)

HCCL_IPADDR_V6_PATTERN = r"ipaddr:(" + IPV6_ADDR_PATTERN + r")"
HCCL_IP_INFO_V6 = r"hccn_tool -i (\d{1,3}) -ip -inet6 -g"
HCCL_IPV6_ADDR = r"ipv6_address:(" + IPV6_ADDR_PATTERN + r")"
...
NPU_HOST_SOURCE = "NPU_Host"
NPU_HISTORY_SOURCE = "NPU_History"
NPU_UBCTL_SOURCE = "NPU_Ubctl"
OS_SOURCE = "OS"
...
SAVER_TO_SOURCE_FILE_MAP = {
    ...
    "DevLogSaver": [NPU_OS_SOURCE, NPU_DEVICE_SOURCE, NPU_HISTORY_SOURCE, NPU_UBCTL_SOURCE],
