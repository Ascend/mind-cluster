...
def main():
    ...
    default_config = os.path.expanduser("~/.diag_tool/parse_config.json")
    parser.add_argument('-c', '--config', default=default_config,
                        help='JSON配置文件路径（必填）')
    # 输出路径默认值：~/.diag_tool/parse_result.json
    default_output = os.path.expanduser("~/.diag_tool/parse_result.json")
