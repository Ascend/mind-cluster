...
from diag_tool.core.common.constants import CMD_EXEC_SUCCESS
from diag_tool.core.model.host import HCCNOpticalInfo, HCCNLinkStatInfo, HCCNLinkHistory, HCCNStatInfo, HCCNLLDPInfo, \
