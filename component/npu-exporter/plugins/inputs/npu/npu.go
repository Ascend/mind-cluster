...
func (npu *NpuWatch) packDcmiInfo(devID int32, fields map[string]interface{}, acc telegraf.Accumulator) {
	...
	fields["npu_chip_info_health_status_v2"] = hccn.GetHealthCodeV2(health)
	...
	fields["npu_chip_info_network_status_v2"] = hccn.GetNetworkHealthyV2(netCode)
...
func (npu *NpuWatch) packHccnInfo(devID int32, fields map[string]interface{}, acc telegraf.Accumulator) error {
	...
	fields["npu_chip_info_link_status_v2"] = hccn.GetLinkStatusCodeV2(linkStatus)
