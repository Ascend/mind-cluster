...
func TestRegister(t *testing.T) {
	convey.Convey("TestRegister", t, func() {
		...
		patches.ApplyMethodReturn(&metrics.NetworkBandwidthCollector{}, "IsSupported", true)
		patches.ApplyMethodReturn(&metrics.NetworkLinkCollector{}, "IsSupported", true)
		...
		patches.ApplyMethodReturn(&metrics.UbCollector{}, "IsParallel", false)
		patches.ApplyMethodReturn(&metrics.NetworkCollector{}, "IsParallel", true)
		patches.ApplyMethodReturn(&metrics.NetworkBandwidthCollector{}, "IsParallel", true)
		patches.ApplyMethodReturn(&metrics.NetworkLinkCollector{}, "IsParallel", true)
		patches.ApplyMethodReturn(&metrics.RoceCollector{}, "IsParallel", true)
		patches.ApplyMethodReturn(&metrics.OpticalCollector{}, "IsParallel", true)
