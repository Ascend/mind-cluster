...
require (
	...
	huawei.com/npu-exporter/v5 v5.0.0-RC4.b002
	k8s.io/api v0.25.13
...
replace huawei.com/npu-exporter/v5 => gitee.com/ascend/ascend-npu-exporter/v5 v5.0.0-RC4.b002
