...
# constants for fault report timeout
REPORT_FAULT_TIMEOUT_ENV = "TASKD_REPORT_FAULT_TIMEOUT"
REPORT_FAULT_TIMEOUT_DISABLED = -1
REPORT_FAULT_TIMEOUT_MIN = 300
REPORT_FAULT_TIMEOUT_MAX = 600