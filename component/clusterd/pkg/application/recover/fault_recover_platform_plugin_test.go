...
// TestUpdateRecoverStatus tests the UpdateRecoverStatus function.
func TestUpdateRecoverStatus(t *testing.T) {
	convey.Convey("Testing UpdateRecoverStatus", t, func() {
		testUpdateRecoverStatusCase1()
		testUpdateRecoverStatusCase2()
		testUpdateRecoverStatusCase3()
	})
}

// testUpdateRecoverStatusCase1 tests the scenario where the recover status is successfully updated.
// Expected result: The ProcessRecoverStatusKey should be present in the PodGroup annotations.
func testUpdateRecoverStatusCase1() {
	convey.Convey("Test case 1: Successful update of recover status. "+
		"Expected: ProcessRecoverStatusKey should be present in PodGroup annotations.", func() {
		pg := &v1beta1.PodGroup{}
		...
		patches := gomonkey.ApplyFunc(kube.RetryGetPodGroup,
			...
			ApplyFunc(kube.RetryUpdatePodGroup,
				func(pg *v1beta1.PodGroup, times int) (*v1beta1.PodGroup, error) {
					pg.Annotations[constant.ProcessRecoverStatusKey] = successString
					return pg, nil
				})
		defer patches.Reset()

		UpdateRecoverStatus(testPgName, testNameSpace, successString)
		_, ok := pg.Annotations[constant.ProcessRecoverStatusKey]
		convey.So(ok, convey.ShouldBeTrue)
	})
}

// testUpdateRecoverStatusCase2 tests the scenario where getting the PodGroup fails.
// Expected result: The ProcessRecoverStatusKey should not be present in the PodGroup annotations.
func testUpdateRecoverStatusCase2() {
	convey.Convey("Test case 2: Failed to get PodGroup. "+
		"Expected: ProcessRecoverStatusKey should not be present in PodGroup annotations.", func() {
		pg := &v1beta1.PodGroup{}
		pg.Annotations = make(map[string]string)
		patches := gomonkey.ApplyFunc(kube.RetryGetPodGroup,
			func(name, namespace string, times int) (*v1beta1.PodGroup, error) {
...
// testUpdateRecoverStatusCase3 tests the scenario where updating the PodGroup fails.
// Expected result: The ProcessRecoverStatusKey should not be present in the PodGroup annotations.
func testUpdateRecoverStatusCase3() {
	convey.Convey("Test case 3: Failed to update PodGroup. "+
		"Expected: ProcessRecoverStatusKey should not be present in PodGroup annotations.", func() {
		pg := &v1beta1.PodGroup{}
		pg.Annotations = make(map[string]string)
		patches := gomonkey.ApplyFunc(kube.RetryGetPodGroup,
		...
		patches = gomonkey.ApplyFunc(kube.RetryUpdatePodGroup,
			func(pg *v1beta1.PodGroup, times int) (*v1beta1.PodGroup, error) {
				return &v1beta1.PodGroup{}, mockErr
			})
		defer patches.Reset()
