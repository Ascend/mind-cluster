...
func TestSetParameterPlaneUnhealthyTolerance(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "01-Ascend910 multi-task annotation=ignore should set true",
			reqNPUName:  util.NPU910CardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: util.ParameterPlaneUnhealthyToleranceIgnoreValue},
			npuTaskNum:  2,
			wantIgnored: true,
		},
		{
			name:        "02-Ascend910 multi-task annotation=no should set false",
			reqNPUName:  util.NPU910CardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: "no"},
			npuTaskNum:  2,
			wantIgnored: false,
		},
		{
		...
		{
			name:        "07-huawei.com/npu multi-task annotation=ignore should set true",
		...
		{
			name:        "08-huawei.com/npu multi-task annotation=no should set false",
			reqNPUName:  util.NPUCardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: "no"},
			npuTaskNum:  2,
			wantIgnored: false,
		...
		{
			name:        "09-Ascend310P multi-task annotation=ignore should keep false (not supported)",
		...
		{
			name:        "11-Ascend910 multi-task annotation=ignore and other keys should set true",
			reqNPUName:  util.NPU910CardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: util.ParameterPlaneUnhealthyToleranceIgnoreValue, "other-key": "val"},
			npuTaskNum:  2,
			wantIgnored: true,
		},
		{
		...
		{
			name:        "14-Ascend910 single-task (1) annotation=no should set true",
			reqNPUName:  util.NPU910CardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: "no"},
			npuTaskNum:  1,
			wantIgnored: true,
		...
		{
			name:        "16-Ascend910 single-task (1) annotation=ignore should set true",
			reqNPUName:  util.NPU910CardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: util.ParameterPlaneUnhealthyToleranceIgnoreValue},
			npuTaskNum:  1,
			wantIgnored: true,
		...
		{
			name:        "19-Ascend910 zero-task (0) annotation=no should set true",
			reqNPUName:  util.NPU910CardName,
			annotation:  map[string]string{util.ParameterPlaneUnhealthyToleranceAnnoKey: "no"},
			npuTaskNum:  0,
			wantIgnored: true,
