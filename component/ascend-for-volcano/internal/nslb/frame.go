...
func (th *TorHandler) Reclaimable(_ *api.TaskInfo, _ []*api.TaskInfo, _ *plugin.NPUNode) ([]*api.TaskInfo, bool) {
	klog.V(util.LogInfoLev).Infof("%s Reclaimable: NSLB policy does not support reclaim", th.GetPluginName())
	return nil, false
}
