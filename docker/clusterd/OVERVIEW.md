...
|-----------|---------------|--------------------------------------|
| `version` | `v26.1.1`     | Version Number of ClusterD           |
| `os`      | `ubuntu22.04` | Operating System for ClusterD Images |

### ClusterD Latest Version 26.1.1

The following are all images of the latest released 26.1.1 version of ClusterD. For all historical
version Tags, please refer to [Supported Tags](https://gitcode.com/Ascend/mind-cluster/blob/master/docker/clusterd/supported_tags.md).

| Tag                      | Dockerfile                                                                                                               | Image Content                                  |
|--------------------------|--------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| `v26.1.1-ubuntu22.04`    | [Dockerfile.ubuntu](https://gitcode.com/Ascend/mind-cluster/blob/master/docker/clusterd/v26.1.1/Dockerfile.ubuntu)       | ClusterD v26.1.1 (Base Image: Ubuntu 22.04)    |
| `v26.1.1-openeuler24.03` | [Dockerfile.openeuler](https://gitcode.com/Ascend/mind-cluster/blob/master/docker/clusterd/v26.1.1/Dockerfile.openeuler) | ClusterD v26.1.1 (Base Image: openEuler 24.03) |
